 ...
 * @date Aug 31, 2011
 */
public class RefinementCommand extends VCGCommand<Pred>
{
  @Override
  ...
  protected VCEnvAnn<Pred> generateVCS(ZSect zSect, SectionManager manager) throws VCGException
  {
    ...
    RefinementUtils.getRefinementUtils().getRefinementVCG().setSectionManager(manager);
    ...
    VCEnvAnn<Pred> result = RefinementUtils.getRefinementUtils().calculateZSectVCEnv(zSect);
    return result;
  }
}
