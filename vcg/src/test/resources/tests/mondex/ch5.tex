...
\begin{theorem}{lPayDetailsSpaceFiniteMaxType}
...
\begin{theorem}{lBetweenWorldFullExpansion}
    ...
    \forall BetweenWorld @ conAuthPurse \in NAMES \finj ConPurse \land
        ...
        %\znote{AuxWorld components and invariant} 
        \t1
...
\begin{zed}
  Ignore ~~\defs~~ [~ \Xi BetweenWorld; name?: NAMES; m?, m! : MESSAGE | m! = mondexError ~]
\end{zed}~\end{LSDef}
