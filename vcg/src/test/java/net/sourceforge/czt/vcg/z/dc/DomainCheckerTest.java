...
//
///**
// * A JUnit test class for testing the VCG. This reads any
// * files not ending with a "_" from the directory tests/?.
// *
...
// * @author Leo Freitas
// */
//public class DomainCheckerTest extends TestCase /*extends VCGTest*/ implements DomainCheckPropertyKeys
//{
//  // true => looks into tests/circus/debug/*.tex;
//  // false=> looks into tests/circus/*.tex
//  protected final static boolean DEBUG_TESTING = false; // true;
...
//    try
//    {
//      manager_ = DomainCheckUtils.getDCUtils().createSectionManager(
...
//        fileName.indexOf(VCG_DOMAINCHECK_VCNAME_SUFFIX) == - 1 && // don't process _dc files for testing
...
//          DomainCheckUtils.getDCUtils().getVCG().config();
...
//              VCEnvAnn<Pred> zSectDCEnvAnn = DomainCheckUtils.getDCUtils().calculateZSectVCEnv(zSect);
