...
package net.sourceforge.czt.gnast.velo;
 ...
 * @author Petra Malik
 */
public class GnastObjectImpl implements GnastObject
{
  /**
  ...
  /**
   * Constructs a new GnastObject with the given name and package name.
   *
   ...
   */
  public GnastObjectImpl(String name, String packageName)
  {
