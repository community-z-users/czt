...
public class GnastException extends RuntimeException
{
  ...
  public GnastException(String message)
  {
    super(message);
  }

  public GnastException(String message, Throwable cause)
  {
    super(message, cause);
  }

  public GnastException(Throwable cause)
  {
    super(cause);
  }
}
