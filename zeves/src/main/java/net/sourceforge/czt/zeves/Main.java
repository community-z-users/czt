/**
Copyright 2007, Leo Freitas, Petra Malik
...
*/
package net.sourceforge.czt.z2jml;
...
/** 
 *  Translate a Z specification from ZML format into JML format. 
 *  It takes a file spec.tex and produces two files spec.java and spec.jml.
 * 
 * @author Leo Freitas
 */
public class Main
{
  public static void main(String[] args)
  {
    try {
      ...
      Handler handler = new FileHandler("z2jml.log");
      handler.setLevel(Level.ALL);
      handler.setEncoding("utf8");
      Logger.getLogger("").addHandler(handler);
      Logger z2jmlLogger = Logger.getLogger("net.sourceforge.czt.z2jml");
      z2jmlLogger.setLevel(Level.FINEST);
      ...
      z2jmlLogger.fine("input file is " + input);
