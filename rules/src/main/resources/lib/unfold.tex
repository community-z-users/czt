...
\begin{zedrule}{SchemaComposition}
  ...
  \proviso E5 == [D2 | true]~_{9} \\ % E5 == E8~_{9}
  \proviso E6 == \theta E3~_{9} \\
  \proviso [D7 | true] == primenames [D2 | true] \\
  \proviso E8 == [D2 | true ] \schemaminus [D7 | true] \\
  \proviso E9 == \theta E8 ~'_{9}
\derives
  E1 \semi E2 =
  (\exists E5 @ (\exists E3 @ [E1; E5 | \theta E3 = E6])
                \land
                (\exists E8 @ [E2; E5 | \theta E8 = E9]))
\end{zedrule}
