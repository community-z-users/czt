...
The framework has been used to obtain positive and negative tests for
...
Finally, Section~\ref{sect:conclusions} gives a conclusion.
...
In this paper, we have presented a framework for testing Z
specifications.  Testing is a useful task, especially when the
