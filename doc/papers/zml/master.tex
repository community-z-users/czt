...
% TODO: explain why unparsed parts (Currie/Toyn)  (Are they useful?)
%       mention separate annotations (Currie/Toyn)
%  Make XMLSpy diagrams smaller.
...
A boolean attribute \AFont{Anon} records whether the section was
...
Z constructs.  Also, \AFont{Spec} and \AFont{Sect} have the XML
