...
\item Mathematical Symbols.  We expect that the special symbols used in Z
  ...
  contents) so that the Z specifications can be pure ASCII?  Or is this
  just a transient problem that will become unimportant once 
  full Unicode fonts and Unicode editors become widely available?
\end{enumerate}
