...
generated by XML-Spy.  These diagrams use two connectors: the
...
the elements on its right.  Also, dotted lines indicate optional
components, but this is usually obvious from the repetition counts (e.g.,
...
arbitrary sequence of unparsed Unicode\footnote{We also allow an
  \AFont{UnparsedPara} to contain annotations.}.  If a tool attempts to parse
...
\item Two alternative approaches to narrative and non-standard portions of
  ...
  The latter approach makes it easy to add new kinds of paragraphs
