...
\label{parsers}
  ...
  \begin{itemize}
    ...
    \item[Petra] I suspect it wouldn't help much.  I think we even
                 tried to use ZML versions of the toolkit (is that
                 what you mean with hard-coded toolkits?), but then
                 the loading time for JAXB and XML parser classes made
                 it slow again.  Having a section manager helps since
                 it makes sure that the toolkit is only parsed once.
  \end{itemize}
