...
\begin{itemize}
  \item [Petra] The following does not really fit into the paper
    because it is more a step by step guide how to extend CZT (which
    is only a subtheme of the paper theme).  I discussed with Mark
    that the conclusions outlined above should be sufficient.  Adding
    all the extension strategies turns out to be too verbose.  Leo,
    are you happy with removing the paragraph below?
\end{itemize}
