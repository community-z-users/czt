...
\section{Conclusions and Future Work} \label{sec:conclusions}
  ...
  their framework as extensible as possible.
    ...
    \item[Leo:] Ok. I think this is sound. However, what about rewriting then
        as future work? And what about a paragraph resuming that section on
        Circus2Java as future work as well?
    \end{description}
