...
\end{small}
  ...
  standard visitor pattern are that it
...
\subsection{Extending ZLive}
    ...
    %
    % Furthermore, we expect to include in ZLive predicate transformers,
    % schema unfolding, and a tactic language in the spirit of 
    % ANGEL~\cite{z.others:angel}.
