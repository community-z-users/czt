...
MARK: I think we can shorten the next three paragraphs to just a
few sentences (to explain the delegation).
...
Mark: should we remove this next para?  It sounds like just a use of standard
OO subclassing, with the unify method being overridden and calling super?
...
overriding method first checks if the types are class types, and
