...
\label{section-manager}
  ...
  \emph{section manager} to enquire about specific aspects of a
  ...
  While it is possible to hard-code these dependencies and let, for
  ...
  to have a kind of data manager that is responsible for this task.
