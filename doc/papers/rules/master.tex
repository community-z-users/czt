...
A rule can refer to three kinds of symbols:
those of the core Z language,
such as $\power$, $\nat$ and $\varg = \varg$;
those defined explicitly using Standard Z in a section,
...
could be bound to a different definition of $dom$,
...
evaluating to PASS if those unifications succeed
...
\item[Lookup:] $\proviso Name \hasDefn Expr$.
  ...
  whose right-hand side unifies with the expression.
