...
\also
  ...
  \t1 content~sm' = \{key\} \ndres content~sm ) \\
\end{axdef}
TODO: specify preconditions of these?  Do they ever throw exceptions?
...
\where
  ...
  \t1 (\exists tmp:SectMan | execute(cmd,sm,args) = (tmp,args',res') @\\
...
TODO: adds isAvailable(Class) to SectMan?
