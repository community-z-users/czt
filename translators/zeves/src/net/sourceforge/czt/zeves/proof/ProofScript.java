...
public class ProofScript {
    ...
    public void addInvokeCommand(RefName ref) {
    ...
    public void addWithDisabledCommand(List<RefName> eventNameList, ProofCommand cmd) {
    ...
    public void addWithEnabledCommand(List<RefName> eventNameList, ProofCommand cmd) {
        /* NOTE: 
         * 
