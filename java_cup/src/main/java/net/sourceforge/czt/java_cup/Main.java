 ...
 *   <dt> -noscanner
 *   <dd> don't refer to net.sourceforge.czt.java_cup.runtime.Scanner in the parser
...
public class Main {
   ...
   *  net.sourceforge.czt.java_cup.runtime.Scanner for compatibility with old runtimes? */
...
"    -noscanner     don't refer to net.sourceforge.czt.java_cup.runtime.Scanner\n" +
