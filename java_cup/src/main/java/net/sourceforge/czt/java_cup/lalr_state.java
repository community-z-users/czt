 ...
 *
 * @see     net.sourceforge.czt.java_cup.lalr_item
 * @see     net.sourceforge.czt.java_cup.lalr_item_set
 * @see     net.sourceforge.czt.java_cup.lalr_transition
...
public class lalr_state {
   ...
   * @see   net.sourceforge.czt.java_cup.lalr_item_set#compute_closure
   * @see   net.sourceforge.czt.java_cup.lalr_state#propagate_all_lookaheads
   */
