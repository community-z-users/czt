 ...
 * 
 * @see     net.sourceforge.czt.java_cup.production_part
 * @see     net.sourceforge.czt.java_cup.symbol_part
 * @see     net.sourceforge.czt.java_cup.action_part
...
public class production {
  ...
  protected String make_declaration(
				    ...
				    int     offset)
    {
      ...
      if (emit.lr_values())
        ret = "\t\tint " + labelname + "left = ((net.sourceforge.czt.java_cup.runtime.Symbol)" + 
	  emit.pre("stack") + ".elementAt(" + emit.pre("top") + 
	  "-" + offset + ")).left;\n" +
	  "\t\tint " + labelname + "right = ((net.sourceforge.czt.java_cup.runtime.Symbol)" + 
	  emit.pre("stack") + ".elementAt(" + emit.pre("top") +
	  "-" + offset + ")).right;\n";
      else ret = "";
	...
	return ret + "\t\t" + stack_type + " " + labelname + " = (" + stack_type + 
	  ")((" + "net.sourceforge.czt.java_cup.runtime.Symbol) " + emit.pre("stack") + ".elementAt(" + emit.pre("top") 
	  + "-" + offset + ")).value;\n";
