 ...
 *
 * @see net.sourceforge.czt.java_cup.main
...
public class emit {
  ...
  protected static void emit_action_code(PrintWriter out, production start_prod)
    throws internal_error
    {
      ...
      out.println("  public final net.sourceforge.czt.java_cup.runtime.Symbol " +
                     pre("do_action") + "(");
      out.println("    int                        " + pre("act_num,"));
      out.println("    net.sourceforge.czt.java_cup.runtime.lr_parser " + pre("parser,"));
      ...
      for (Enumeration p = production.all(); p.hasMoreElements(); )
        {
          ...
          out.println("    net.sourceforge.czt.java_cup.runtime.Symbol case" + prod.index() + "(");
          out.println("    int                        " + pre("act_num,"));
          out.println("    net.sourceforge.czt.java_cup.runtime.lr_parser " + pre("parser,"));
          out.println("    java.util.Stack            " + pre("stack,"));
          out.println("    int                        " + pre("top)"));
...
//              + emit.pre("top") + "-" + index + ")).value != null )");
  ...
  public static void parser(
    ...
    throws internal_error
    {
      ...
      out.println("  public net.sourceforge.czt.java_cup.runtime.Symbol do_action(");
      out.println("    int                        act_num,");
      out.println("    net.sourceforge.czt.java_cup.runtime.lr_parser parser,");
      ...
      if (scan_code != null)
        {
          ...
          out.println("  public net.sourceforge.czt.java_cup.runtime.Symbol scan()");
          out.println("    throws java.lang.Exception");
          out.println("    {");
