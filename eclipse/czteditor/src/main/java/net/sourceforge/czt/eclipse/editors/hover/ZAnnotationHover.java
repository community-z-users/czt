...
public class ZAnnotationHover implements IAnnotationHover
{
  ...
  {
    Assert.isTrue(VERTICAL_RULER_HOVER.equals(type)
        || TEXT_RULER_HOVER.equals(type) || OVERVIEW_RULER_HOVER.equals(type));
    fType = type;
  }
  ...
  {
    return EditorsUI.getAnnotationPreferenceLookup().getAnnotationPreference(
        annotation);
  }
}
