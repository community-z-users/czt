 ...
 * @author Chengdong Xu
 */
public class ZSourceViewer extends ProjectionViewer
    implements
      IPropertyChangeListener
{
   ...
   * @param styles
   */
  public ZSourceViewer(Composite parent, IVerticalRuler verticalRuler,
      IOverviewRuler overviewRuler, boolean showsAnnotationOverview,
      int styles, IPreferenceStore store)
  {
    super(parent, verticalRuler, overviewRuler, showsAnnotationOverview, styles);
   ...
   *//*
   ...
   IFormattingContext context= new ZFormattingContext();
   Map map= new HashMap();
  ...
  public void configure(SourceViewerConfiguration configuration)
  {
    ...
    /*
     if (configuration instanceof ZSourceViewerConfiguration) {
     ZSourceViewerConfiguration ZSVCconfiguration = (ZSourceViewerConfiguration) configuration;
     fOutlinePresenter = ZSVCconfiguration.getOutlinePresenter(this, false);
     if (fOutlinePresenter != null)
     fOutlinePresenter.install(this);

     fStructurePresenter = ZSVCconfiguration
     .getOutlinePresenter(this, true);
     if (fStructurePresenter != null)
     fStructurePresenter.install(this);

     fHierarchyPresenter = ZSVCconfiguration.getHierarchyPresenter(this,
     true);
     if (fHierarchyPresenter != null)
    ...
    if (fPreferenceStore != null) {
      ...
      Color color = fPreferenceStore
          ...
          : createColor(fPreferenceStore,
              AbstractTextEditor.PREFERENCE_COLOR_FOREGROUND, styledText
                  .getDisplay());
      ...
      color = fPreferenceStore
          ...
          ? null
          : createColor(fPreferenceStore,
              AbstractTextEditor.PREFERENCE_COLOR_BACKGROUND, styledText
                  .getDisplay());
