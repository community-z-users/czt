 ...
 * @author Chengdong Xu
 */
public class ZCodeScanner extends RuleBasedScanner {
	...
	/**
	 * Creates a Z code scanner
	 */
	public ZCodeScanner(CZTColorManager colorManager) {
		...
		rules.add(new WhitespaceRule(new ZWhitespaceDetector()));

		// Add word rule for keywords, types, tags and constants.
		WordRule wordRule = new WordRule(new ZWordDetector(), otherToken);
