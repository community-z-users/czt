...
import net.sourceforge.czt.eclipse.editors.latex.ZLatexWhitespaceDetector;
import net.sourceforge.czt.eclipse.editors.latex.ZLatexWordDetector;
...
public class ZUnicodeCodeScanner extends RuleBasedScanner {
	 ...
	 */
	public ZUnicodeCodeScanner(CZTColorManager colorManager) {
...
//		rules.add(new EndOfLineRule("%", singleLineCommentToken, '%')); //$NON-NLS-1$
		...
		WordRule wordRule = new WordRule(new ZUnicodeWordDetector(), otherToken);
