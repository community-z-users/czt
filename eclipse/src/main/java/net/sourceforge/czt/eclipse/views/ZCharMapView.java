...
//		contributeToActionBars();
	...
	private void createTable(Composite parent) {
		...
		charCombo.setItems(new String[] {"Unicode Markup", "Latex Markup", "Hex String"});
		charCombo.select(0);
		...
		table.addMouseTrackListener(new MouseTrackListener() {
			...
			public void mouseHover(MouseEvent event) {
			    ...
			    if (zch != null) {
			        String descString = zch.getDescription()
	        	    	+ "(Unicode:" + zch.getUnicode()
	        	    	+ "; Latex:" + zch.getLatex();
			        descString = descString.replaceAll("\n", "...");
	        	    descriptionLabel.setText(descString);
		        }
			}
		});
