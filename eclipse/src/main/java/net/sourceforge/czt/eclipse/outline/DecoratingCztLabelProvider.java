...
import net.sourceforge.czt.eclipse.editors.ProblemsLabelDecorator;
...
public class DecoratingCztLabelProvider extends DecoratingLabelProvider
	 ...
	 */
	public DecoratingCztLabelProvider(ILabelProvider labelProvider, boolean errorTick) {
...
//		super(labelProvider, new ProblemsLabelDecorator(null));
		super(labelProvider, new ProblemsLabelDecorator(CZTPlugin.getImageDescriptorRegistry()));
	}
