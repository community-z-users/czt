...
public class ZPerspectiveFactory implements IPerspectiveFactory
{
  ...
  private static final String ID_PERSPECTIVE = "net.sourceforge.czt.eclipse.perspectives";
  ...
  private static final String ID_Z_CHARMAP_VIEW = "net.sourceforge.czt.eclipse.views.ZCharMapView";
