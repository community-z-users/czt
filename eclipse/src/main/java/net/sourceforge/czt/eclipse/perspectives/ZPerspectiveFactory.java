...
public class ZPerspectiveFactory implements IPerspectiveFactory {
	...
	private static final String ID_PERSPECTIVE =
			"net.sourceforge.czt.eclipse.perspectives";
	
	private static final String ID_RESOURCE_PERSPECTIVE =
			"org.eclipse.ui.resourcePerspective";
	
	private static final String ID_JAVA_PERSPECTIVE =
			"org.eclipse.jdt.ui.JavaPerspective";
	
	private static final String ID_JAVA_BROWSING_PERSPECTIVE =
			"org.eclipse.jdt.ui.JavaBrowsingPerspective";
	
	private static final String ID_JAVA_HIERARCHY_PERSPECTIVE =
			"org.eclipse.jdt.ui.JavaHierarchyPerspective";
	
	private static final String ID_Z_CHARMAP_VIEW =
			"net.sourceforge.czt.eclipse.views.ZCharMapView";
	
	private static final String ID_CONSOLE_VIEW =
			IConsoleConstants.ID_CONSOLE_VIEW;
	
	private static final String ID_SEARCH_VIEW =
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		IFolderLayout bottom = layout.createFolder(
				...
				0.75f,
				editorArea);
		bottom.addView(ID_Z_CHARMAP_VIEW); //$NON-NLS-1$
		...
		layout.addPerspectiveShortcut(ID_PERSPECTIVE); //$NON-NLS-1$
		...
		layout.addShowViewShortcut(ID_Z_CHARMAP_VIEW); //$NON-NLS-1$
