...
public class Z2AlloyTest
{
	...
	@Test public void testGiven1() { test("given1", true); }
	/** tests more than one given type */
	@Test public void testGiven2() { test("given2", true); }
	/** tests a free type */
	@Test public void testFree1() { test("free1", true); }
	/** tests a schema which which declares a variable of a free type */
	@Test public void testSchema1() { test("schema1", true); }
	/** tests a schema which declares a variable of a schema. This doesn't work with unfolding */ 
	@Test public void testSchema2() { test("schema2", false); }
	/** tests a schema which includes a schema */
	@Test public void testSchema3() { test("schema3", true); }
	/** tests a schema with an equality constraint */
	@Test public void testEquality1() { test("equality1", true); }
	/* tests logical and, or, not, implication, iff */
	// wip @Test public void testBooleanOperators1() { test("booleanoperators1", true); }
