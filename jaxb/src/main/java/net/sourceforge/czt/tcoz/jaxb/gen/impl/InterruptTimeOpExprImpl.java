    ...
    implements net.sourceforge.czt.tcoz.jaxb.gen.InterruptTimeOpExpr, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    protected net.sourceforge.czt.z.jaxb.gen.Expr _IntOrTimeout;
    ...
    public net.sourceforge.czt.z.jaxb.gen.Expr getIntOrTimeout() {
        return _IntOrTimeout;
    }

    public void setIntOrTimeout(net.sourceforge.czt.z.jaxb.gen.Expr value) {
        _IntOrTimeout = value;
    }
...
+"t.oz.jaxb.gen.OpExprq\u0000~\u0000$sq\u0000~\u0000\bppsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001f"
+"sq\u0000~\u0000 t\u0000\bNormalOpt\u0000\u001fhttp://czt.sourceforge.net/tcozsq\u0000~\u0000\npp\u0000"
+"sq\u0000~\u0000\u0000ppsq\u0000~\u0000\npp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq"
+"\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000#net.sourceforge.czt.z.jaxb.gen.Exprq\u0000~\u0000$sq\u0000~\u0000\bp"
+"psq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\fIntOrTimeoutq\u0000~\u0000Lsq\u0000~\u0000\n"
+"pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\npp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~"
+"\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 q\u0000~\u0000Gq\u0000~\u0000$sq\u0000~\u0000\bppsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq"
+"\u0000~\u0000 t\u0000\tHandlerOpq\u0000~\u0000Lsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000"
...
+"v/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0014\u0001pq\u0000~\u0000\u0015q\u0000~\u0000Dq\u0000~\u0000Qq\u0000~\u0000]q\u0000~\u0000\u0005q\u0000"
+"~\u0000%q\u0000~\u0000Hq\u0000~\u0000Uq\u0000~\u0000`q\u0000~\u0000\u0007q\u0000~\u0000\u0010q\u0000~\u0000Aq\u0000~\u0000Nq\u0000~\u0000Zq\u0000~\u0000\tq\u0000~\u0000\u0012q\u0000~\u0000Cq\u0000"
+"~\u0000Pq\u0000~\u0000\\q\u0000~\u0000\u0006x"));
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  5 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _IntOrTimeout = ((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl.class), 6, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _IntOrTimeout = ((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl.class), 6, ___uri, ___local, ___qname, __atts));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        return ;
                    case  5 :
                        _IntOrTimeout = ((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl) spawnChildFromLeaveElement((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl.class), 6, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        return ;
                    case  5 :
                        _IntOrTimeout = ((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl.class), 6, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        return ;
                    case  5 :
                        _IntOrTimeout = ((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl) spawnChildFromLeaveAttribute((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl.class), 6, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  0 :
                            ...
                            return ;
                        case  5 :
                            _IntOrTimeout = ((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl) spawnChildFromText((net.sourceforge.czt.z.jaxb.gen.impl.ExprImpl.class), 6, value));
                            return ;
                    }
