...
{
  private static final ZGiven ok = new ZGiven("ok");
  private static final ZGiven already_known = new ZGiven("already_known");
  private static final ZGiven not_known = new ZGiven("not_known");
  ...
  public synchronized void activateSchema(String schemaName)
  {
    ...
    solutionSets
      = new Vector(solutionSets.subList(0, currentSolution.nextIndex() + 1));
