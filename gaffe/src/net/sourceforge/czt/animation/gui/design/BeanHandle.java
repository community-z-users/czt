...
final class BeanHandle extends JPanel
{
  ...
  {
    switch(corner_) {
      case Cursor.N_RESIZE_CURSOR  : case Cursor.NW_RESIZE_CURSOR :
      case Cursor.NE_RESIZE_CURSOR : case Cursor.S_RESIZE_CURSOR  :
      case Cursor.SW_RESIZE_CURSOR : case Cursor.SE_RESIZE_CURSOR :
  ...
  private class DragListener extends MouseInputAdapter
  {
    ...
    public synchronized void mouseDragged(MouseEvent e)
    {
      ...
      switch(corner_) {
        ...
        case Cursor.NW_RESIZE_CURSOR : case Cursor.NE_RESIZE_CURSOR :
      ...
      switch(corner_) {
        ...
        case Cursor.NW_RESIZE_CURSOR :case Cursor.SW_RESIZE_CURSOR :
        ...
        case Cursor.NE_RESIZE_CURSOR : case Cursor.SE_RESIZE_CURSOR:
  ...
  protected void setLocation()
  {
    ...
    switch(corner_) {
      ...
      case Cursor.NE_RESIZE_CURSOR : case Cursor.SE_RESIZE_CURSOR :
        ...
        break;
      case Cursor.N_RESIZE_CURSOR  :
      case Cursor.S_RESIZE_CURSOR  : case Cursor.MOVE_CURSOR :
    ...
    newLocation
      = formDesign_.translateCoordinateFromCSpace(newLocation,
