...
public class ColorEditor extends PropertyEditorSupport {
  ...
  public ColorEditor() {
    ...
    if(getValue()==null) setValue(Color.white);
    colourChooser=new JColorChooser((Color)getValue());

    chooserDialog
      =JColorChooser.createDialog(null,"Colour Selector",true,colourChooser,
				  new ActionListener() {
  ...
  public String getAsText() {
    ...
    return "Colour - RGBA("+c.getRed()+","+c.getGreen()+","+c.getBlue()+","+c.getAlpha()+")";
  };
