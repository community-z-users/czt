...
public class HistoryProxy extends BeanContextChildSupport
{
  ...
  private final PropertyChangeListener pcListener
    ...
    {
      pcSupport
        .firePropertyChange(new PropertyChangeEvent(HistoryProxy.this,
                                                    evt.getPropertyName(),
                                                    evt.getOldValue(),
                                                    evt.getNewValue()));
      if (evt.getPropertyName().equals("currentSolution")) {
        ActionListener[] listeners
          = (ActionListener[]) ell.getListeners(ActionListener.class);
        ActionEvent ev
          = new ActionEvent(this, AWTEvent.RESERVED_ID_MAX + 1,
