...
/**
 * Records the details of a formal Z paragraph.
 * 
 * @author ian
 */
public final class FormalParaBlock extends ParaBlock
{
  /**
   * Constructs a formal Z paragraph block.
   * 
   ...
   */
  public FormalParaBlock(StringBuilder text, boolean isBufferingWanted, int lineNo, int columnNo, int charNo)
  {
