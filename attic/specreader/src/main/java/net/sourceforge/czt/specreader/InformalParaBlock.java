...
/**
 * Records the details of an informal narrative paragraph.
 * 
 * @author ian
 */
public final class InformalParaBlock extends ParaBlock
{
  /**
   * Constructs an niformal narrative paragraph block.
   * 
   ...
   */
  public InformalParaBlock(StringBuilder text, boolean isBufferingWanted, int lineNo, int columnNo, int charNo)
  {
