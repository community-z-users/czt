...
\begin{zed}
TokenWithValidAuth1 \defs TokenWithValidAuth0 \setminus  (ac)
\end{zed}
...
\where
  ...
  \ELSE
  	doorAlarm = silent \land  (\IF  currentLatch = locked \THEN  ([|currentTime \geq  latchTimeout \land  (currentDoor = open \implies  currentTime < alarmTimeout)])
  \ELSE
...
\begin{zed}
AddElementsToLog2 \defs AddElementsToLog20 \setminus  (newElements)
\end{zed}
