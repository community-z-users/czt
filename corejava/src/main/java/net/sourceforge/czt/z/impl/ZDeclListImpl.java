...
public class ZDeclListImpl
  extends java.util.AbstractList<Decl>
  implements ZDeclList
{
   ...
   */
  /*@ non_null @*/
  private List<Decl> list_ = new ArrayList<Decl>();
  ...
  protected ZDeclListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
   ...
   */
  public void add(int index, Decl element)
  {
   ...
   */
  public Decl set(int index, Decl element)
  {
  ...
  {
    if (v instanceof ZDeclListVisitor) {
      ZDeclListVisitor<R> visitor = (ZDeclListVisitor<R>) v;
      return visitor.visitZDeclList(this);
    }
  ...
  public ZDeclListImpl create(Object[] args)
  {
    ZDeclListImpl result = new ZDeclListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((Decl) args[i]);
    }
    return result;
  }
}
