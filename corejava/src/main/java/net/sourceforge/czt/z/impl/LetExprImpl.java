  ...
  extends Qnt1ExprImpl   implements LetExpr
{
  ...
  protected LetExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof LetExprVisitor) {
      LetExprVisitor<R> visitor = (LetExprVisitor<R>) v;
   ...
   */
  public LetExprImpl create(Object[] args)
  {
    LetExprImpl zedObject = null;
    try {
      SchText schText = (SchText) args[0];
      Expr expr = (Expr) args[1];
      zedObject = new LetExprImpl(getFactory());
