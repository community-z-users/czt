...
import net.sourceforge.czt.z.visitor.DeclNameListVisitor;
 ...
 */
public abstract class DeclNameListImpl
  extends TermImpl   implements DeclNameList
{
  /**
  ...
  protected DeclNameListImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof DeclNameListVisitor) {
      DeclNameListVisitor<R> visitor = (DeclNameListVisitor<R>) v;
