  ...
  extends StrokeImpl   implements NextStroke
{
  ...
  protected NextStrokeImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof NextStrokeVisitor) {
      NextStrokeVisitor<R> visitor = (NextStrokeVisitor<R>) v;
   ...
   */
  public NextStrokeImpl create(Object[] args)
  {
    NextStrokeImpl zedObject = null;
    try {
      zedObject = new NextStrokeImpl(getFactory());
    }
