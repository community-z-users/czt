  ...
  extends Expr2NImpl   implements ProdExpr
{
  ...
  protected ProdExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ProdExprVisitor) {
      ProdExprVisitor<R> visitor = (ProdExprVisitor<R>) v;
   ...
   */
  public ProdExprImpl create(Object[] args)
  {
    ProdExprImpl zedObject = null;
    try {
      ExprList exprList = (ExprList) args[0];
      zedObject = new ProdExprImpl(getFactory());
