  ...
  extends QntPredImpl   implements ExistsPred
{
  ...
  protected ExistsPredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ExistsPredVisitor) {
      ExistsPredVisitor<R> visitor = (ExistsPredVisitor<R>) v;
   ...
   */
  public ExistsPredImpl create(Object[] args)
  {
    ExistsPredImpl zedObject = null;
    try {
      SchText schText = (SchText) args[0];
      Pred pred = (Pred) args[1];
      zedObject = new ExistsPredImpl(getFactory());
