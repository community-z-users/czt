  ...
  extends Pred2Impl   implements ImpliesPred
{
  ...
  protected ImpliesPredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ImpliesPredVisitor) {
      ImpliesPredVisitor<R> visitor = (ImpliesPredVisitor<R>) v;
   ...
   */
  public ImpliesPredImpl create(Object[] args)
  {
    ImpliesPredImpl zedObject = null;
    try {
      Pred leftPred = (Pred) args[0];
      Pred rightPred = (Pred) args[1];
      zedObject = new ImpliesPredImpl(getFactory());
