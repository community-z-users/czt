  ...
  extends DeclImpl   implements ConstDecl
{
  ...
  protected ConstDeclImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof ConstDeclVisitor) {
      ConstDeclVisitor<R> visitor = (ConstDeclVisitor<R>) v;
   ...
   */
  public ConstDeclImpl create(Object[] args)
  {
    ConstDeclImpl zedObject = null;
    try {
      DeclName declName = (DeclName) args[0];
      Expr expr = (Expr) args[1];
      zedObject = new ConstDeclImpl(getFactory());
