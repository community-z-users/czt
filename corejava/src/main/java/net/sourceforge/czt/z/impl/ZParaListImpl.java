...
public class ZParaListImpl
  extends java.util.AbstractList<Para>
  implements ZParaList
{
   ...
   */
  /*@ non_null @*/
  private List<Para> list_ = new ArrayList<Para>();
   ...
   */
  protected ZParaListImpl()
  {
    factory_ = null;
  }

  protected ZParaListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
   ...
   */
  public void add(int index, Para element)
  {
   ...
   */
  public Para set(int index, Para element)
  {
  ...
  {
    if (v instanceof ZParaListVisitor) {
      ZParaListVisitor<R> visitor = (ZParaListVisitor<R>) v;
      return visitor.visitZParaList(this);
    }
  ...
  public ZParaListImpl create(Object[] args)
  {
    ZParaListImpl result = new ZParaListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((Para) args[i]);
    }
    return result;
  }
}
