  ...
  extends QntExprImpl   implements MuExpr
{
  ...
  protected MuExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof MuExprVisitor) {
      MuExprVisitor<R> visitor = (MuExprVisitor<R>) v;
   ...
   */
  public MuExprImpl create(Object[] args)
  {
    MuExprImpl zedObject = null;
    try {
      SchText schText = (SchText) args[0];
      Expr expr = (Expr) args[1];
      zedObject = new MuExprImpl(getFactory());
