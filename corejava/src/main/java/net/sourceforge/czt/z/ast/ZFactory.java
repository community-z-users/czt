...
public interface ZFactory
{
   ...
   * @return the new instance of Freetype.
   */
  Freetype createFreetype( DeclName  declName, BranchList  branchList);
   ...
   * @return the new instance of NewOldPair.
   */
  NewOldPair createNewOldPair( DeclName  newName, RefName  oldName);
   ...
   * @return the new instance of ZExprList.
   */
  ZExprList createZExprList(java.util.List<? extends Expr>
 expr);
   ...
   * @return the new instance of LatexMarkupPara.
   */
  LatexMarkupPara createLatexMarkupPara(java.util.List<? extends Directive>
 directive);
   ...
   * @return the new instance of Signature.
   */
  Signature createSignature(java.util.List<? extends NameTypePair>
 nameTypePair);
   ...
   */
  ZDeclNameList createZDeclNameList();
   ...
   * @return the new instance of ZDeclNameList.
   */
  ZDeclNameList createZDeclNameList(java.util.List<? extends DeclName>
 declName);
   ...
   * @return the new instance of ZRenameList.
   */
  ZRenameList createZRenameList(java.util.List<? extends NewOldPair>
 newOldPair);
   ...
   * @return the new instance of ZFreetypeList.
   */
  ZFreetypeList createZFreetypeList(java.util.List<? extends Freetype>
 freetype);
   ...
   * @return the new instance of ProdType.
   */
  ProdType createProdType(java.util.List<? extends Type2>
 type);
   ...
   * @return the new instance of ZNumeral.
   */
  ZNumeral createZNumeral( java.math.BigInteger  value);
   ...
   * @return the new instance of VarDecl.
   */
  VarDecl createVarDecl( DeclNameList  declNameList, Expr  expr);
   ...
   * @return the new instance of ZStrokeList.
   */
  ZStrokeList createZStrokeList(java.util.List<? extends Stroke>
 stroke);
   ...
   * @return the new instance of NameTypePair.
   */
  NameTypePair createNameTypePair( DeclName  declName, Type  type);
   ...
   */
  ZRefNameList createZRefNameList();
   ...
   * @return the new instance of ZRefNameList.
   */
  ZRefNameList createZRefNameList(java.util.List<? extends RefName>
 refName);
   ...
   * @return the new instance of GenericType.
   */
  GenericType createGenericType(java.util.List<? extends ZDeclName>
 name, Type2  type, Type2  optionalType);
   ...
   * @return the new instance of OptempPara.
   */
  OptempPara createOptempPara(java.util.List<? extends Oper>
 oper, Cat  cat, Assoc  assoc, java.math.BigInteger  prec);
   ...
   * @return the new instance of NameSectTypeTriple.
   */
  NameSectTypeTriple createNameSectTypeTriple( DeclName  declName, String  sect, Type  type);
   ...
   * @return the new instance of SectTypeEnvAnn.
   */
  SectTypeEnvAnn createSectTypeEnvAnn(java.util.List<? extends NameSectTypeTriple>
 nameSectTypeTriple);
   ...
   * @return the new instance of GivenType.
   */
  GivenType createGivenType( ZDeclName  name);
   ...
   * @return the new instance of BindSelExpr.
   */
  BindSelExpr createBindSelExpr( Expr  expr, RefName  refName);
   ...
   * @return the new instance of ZParaList.
   */
  ZParaList createZParaList(java.util.List<? extends Para>
 para);
   ...
   * @return the new instance of Spec.
   */
  Spec createSpec(java.util.List<? extends Sect>
 sect, String  version, String  author, java.util.Calendar  modified, String  source);
   ...
   * @return the new instance of ZDeclList.
   */
  ZDeclList createZDeclList(java.util.List<? extends Decl>
 decl);
   ...
   * @return the new instance of GenParamType.
   */
  GenParamType createGenParamType( ZDeclName  name);
   ...
   * @return the new instance of LocAnn.
   */
  LocAnn createLocAnn( String  loc, java.math.BigInteger  line, java.math.BigInteger  col, java.math.BigInteger  start, java.math.BigInteger  length);
   ...
   * @return the new instance of HideExpr.
   */
  HideExpr createHideExpr( Expr  expr, RefNameList  refNameList);
   ...
   * @return the new instance of GivenPara.
   */
  GivenPara createGivenPara( DeclNameList  declNameList);
   ...
   * @return the new instance of ZBranchList.
   */
  ZBranchList createZBranchList(java.util.List<? extends Branch>
 branch);
   ...
   * @return the new instance of AndPred.
   */
  AndPred createAndPred( Pred  leftPred, Pred  rightPred, And  and);
   ...
   * @return the new instance of ConjPara.
   */
  ConjPara createConjPara( DeclNameList  declNameList, Pred  pred);
   ...
   * @return the new instance of NumStroke.
   */
  NumStroke createNumStroke( net.sourceforge.czt.base.ast.Digit  digit);
   ...
   * @return the new instance of ZSect.
   */
  ZSect createZSect( String  name,java.util.List<? extends Parent>
 parent, ParaList  paraList);
   ...
   * @return the new instance of RefExpr.
   */
  RefExpr createRefExpr( RefName  refName, ExprList  exprList, Boolean  mixfix, Boolean  explicit);
   ...
   * @return the new instance of ZDeclName.
   */
  ZDeclName createZDeclName( String  word, StrokeList  strokeList, String  id);
   ...
   * @return the new instance of AxPara.
   */
  AxPara createAxPara( DeclNameList  declNameList, SchText  schText, Box  box);
   ...
   * @return the new instance of ZRefName.
   */
  ZRefName createZRefName( String  word, StrokeList  strokeList, ZDeclName  decl);
