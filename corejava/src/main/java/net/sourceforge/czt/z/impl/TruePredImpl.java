  ...
  extends FactImpl   implements TruePred
{
  ...
  protected TruePredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof TruePredVisitor) {
      TruePredVisitor<R> visitor = (TruePredVisitor<R>) v;
   ...
   */
  public TruePredImpl create(Object[] args)
  {
    TruePredImpl zedObject = null;
    try {
      zedObject = new TruePredImpl(getFactory());
    }
