...
public abstract class ParaImpl
  extends TermImpl   implements Para
{
  /**
  ...
  protected ParaImpl(BaseFactory factory)
  {
    super(factory);
  }
   ...
   * also a(n) ParaImpl and all the getter methods except getAnns
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ParaVisitor) {
      ParaVisitor<R> visitor = (ParaVisitor<R>) v;
