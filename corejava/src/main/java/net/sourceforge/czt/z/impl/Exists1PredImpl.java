  ...
  extends QntPredImpl   implements Exists1Pred
{
  ...
  protected Exists1PredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof Exists1PredVisitor) {
      Exists1PredVisitor<R> visitor = (Exists1PredVisitor<R>) v;
   ...
   */
  public Exists1PredImpl create(Object[] args)
  {
    Exists1PredImpl zedObject = null;
    try {
      SchText schText = (SchText) args[0];
      Pred pred = (Pred) args[1];
      zedObject = new Exists1PredImpl(getFactory());
