  ...
  extends SchExpr2Impl   implements CompExpr
{
  ...
  protected CompExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof CompExprVisitor) {
      CompExprVisitor<R> visitor = (CompExprVisitor<R>) v;
   ...
   */
  public CompExprImpl create(Object[] args)
  {
    CompExprImpl zedObject = null;
    try {
      Expr leftExpr = (Expr) args[0];
      Expr rightExpr = (Expr) args[1];
      zedObject = new CompExprImpl(getFactory());
