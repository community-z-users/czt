  ...
  extends Pred2Impl   implements IffPred
{
  ...
  protected IffPredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof IffPredVisitor) {
      IffPredVisitor<R> visitor = (IffPredVisitor<R>) v;
   ...
   */
  public IffPredImpl create(Object[] args)
  {
    IffPredImpl zedObject = null;
    try {
      Pred leftPred = (Pred) args[0];
      Pred rightPred = (Pred) args[1];
      zedObject = new IffPredImpl(getFactory());
