...
public class ZRefNameListImpl
  extends java.util.AbstractList<RefName>
  implements ZRefNameList
{
   ...
   */
  /*@ non_null @*/
  private List<RefName> list_ = new ArrayList<RefName>();
   ...
   */
  protected ZRefNameListImpl()
  {
    factory_ = null;
  }

  protected ZRefNameListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
  ...
  public ZRefNameList getRefName()
  {
    return this;
  }
   ...
   */
  public void add(int index, RefName element)
  {
   ...
   *         <code>(index < 0 || index >= size())</code>.
   */
  public RefName remove(int index)
  {
   ...
   */
  public RefName set(int index, RefName element)
  {
  ...
  {
    if (v instanceof ZRefNameListVisitor) {
      ZRefNameListVisitor<R> visitor = (ZRefNameListVisitor<R>) v;
      return visitor.visitZRefNameList(this);
    }
  ...
  public ZRefNameListImpl create(Object[] args)
  {
    ZRefNameListImpl result = new ZRefNameListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((RefName) args[i]);
    }
    return result;
  }
}
