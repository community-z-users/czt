  ...
  extends SectImpl   implements NarrSect
{
  ...
  protected NarrSectImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof NarrSectVisitor) {
      NarrSectVisitor<R> visitor = (NarrSectVisitor<R>) v;
   ...
   */
  public NarrSectImpl create(Object[] args)
  {
    NarrSectImpl zedObject = null;
    try {
      java.util.List content = (java.util.List) args[0];
      zedObject = new NarrSectImpl(getFactory());
