  ...
  extends Qnt1ExprImpl   implements Exists1Expr
{
  ...
  protected Exists1ExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof Exists1ExprVisitor) {
      Exists1ExprVisitor<R> visitor = (Exists1ExprVisitor<R>) v;
      return visitor.visitExists1Expr(this);
    }
   ...
   */
  public Exists1ExprImpl create(Object[] args)
  {
    Exists1ExprImpl zedObject = null;
    try {
      SchText schText = (SchText) args[0];
      Expr expr = (Expr) args[1];
      zedObject = new Exists1ExprImpl(getFactory());
