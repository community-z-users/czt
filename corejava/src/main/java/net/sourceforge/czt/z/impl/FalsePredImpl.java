  ...
  extends FactImpl   implements FalsePred
{
  ...
  protected FalsePredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof FalsePredVisitor) {
      FalsePredVisitor<R> visitor = (FalsePredVisitor<R>) v;
   ...
   */
  public FalsePredImpl create(Object[] args)
  {
    FalsePredImpl zedObject = null;
    try {
      zedObject = new FalsePredImpl(getFactory());
    }
