  ...
  extends AnnImpl   implements SectTypeEnvAnn
{
  ...
  protected SectTypeEnvAnnImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof SectTypeEnvAnnVisitor) {
      SectTypeEnvAnnVisitor<R> visitor = (SectTypeEnvAnnVisitor<R>) v;
  ...
  public SectTypeEnvAnnImpl create(Object[] args)
  {
    ...
    try {
      java.util.List<NameSectTypeTriple> nameSectTypeTriple = (java.util.List<NameSectTypeTriple>) args[0];
  ...
  private ListTerm<NameSectTypeTriple> nameSectTypeTriple_ =
    new ListTermImpl<NameSectTypeTriple>();

  public ListTerm<NameSectTypeTriple> getNameSectTypeTriple()
  {
