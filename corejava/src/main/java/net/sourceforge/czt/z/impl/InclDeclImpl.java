  ...
  extends DeclImpl   implements InclDecl
{
  ...
  protected InclDeclImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof InclDeclVisitor) {
      InclDeclVisitor<R> visitor = (InclDeclVisitor<R>) v;
   ...
   */
  public InclDeclImpl create(Object[] args)
  {
    InclDeclImpl zedObject = null;
    try {
      Expr expr = (Expr) args[0];
      zedObject = new InclDeclImpl(getFactory());
