  ...
  extends ParaImpl   implements LatexMarkupPara
{
  ...
  protected LatexMarkupParaImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof LatexMarkupParaVisitor) {
      LatexMarkupParaVisitor<R> visitor = (LatexMarkupParaVisitor<R>) v;
   ...
   */
  public LatexMarkupParaImpl create(Object[] args)
  {
    LatexMarkupParaImpl zedObject = null;
    try {
      java.util.List<Directive> directive = (java.util.List<Directive>) args[0];
      zedObject = new LatexMarkupParaImpl(getFactory());
      if (directive != null) {
  ...
  private ListTerm<Directive> directive_ =
    new ListTermImpl<Directive>();

  public ListTerm<Directive> getDirective()
  {
    return directive_;
  }
}
