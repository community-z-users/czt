  ...
  extends StrokeImpl   implements InStroke
{
  ...
  protected InStrokeImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof InStrokeVisitor) {
      InStrokeVisitor<R> visitor = (InStrokeVisitor<R>) v;
      return visitor.visitInStroke(this);
    }
   ...
   */
  public InStrokeImpl create(Object[] args)
  {
    InStrokeImpl zedObject = null;
    try {
      zedObject = new InStrokeImpl(getFactory());
    }
