  ...
  extends Expr1Impl   implements RenameExpr
{
  ...
  protected RenameExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof RenameExprVisitor) {
      RenameExprVisitor<R> visitor = (RenameExprVisitor<R>) v;
   ...
   */
  public RenameExprImpl create(Object[] args)
  {
    RenameExprImpl zedObject = null;
    try {
      Expr expr = (Expr) args[0];
      RenameList renameList = (RenameList) args[1];
      zedObject = new RenameExprImpl(getFactory());
  ...
  {
    Object[] erg = { getExpr(), getRenameList() };
    return erg;
  }
