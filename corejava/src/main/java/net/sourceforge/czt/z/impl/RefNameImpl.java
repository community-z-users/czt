 ...
 */
public abstract class RefNameImpl
  extends TermImpl   implements RefName
{
  /**
  ...
  protected RefNameImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof RefNameVisitor) {
      RefNameVisitor<R> visitor = (RefNameVisitor<R>) v;
