...
public class SpecImpl
  extends TermImpl   implements Spec
{
  /**
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof SpecVisitor) {
      SpecVisitor<R> visitor = (SpecVisitor<R>) v;
   ...
   */
  public SpecImpl create(Object[] args)
  {
    SpecImpl zedObject = null;
    try {
      java.util.List<Sect> sect = (java.util.List<Sect>) args[0];
      ...
      zedObject = new SpecImpl(getFactory());
      if (sect != null) {
  ...
  private ListTerm<Sect> sect_ =
    new ListTermImpl<Sect>();
