  ...
  extends AnnImpl   implements SignatureAnn
{
   ...
   */
  protected SignatureAnnImpl()
  {
  }

  protected SignatureAnnImpl(BaseFactory factory)
  {
    super(factory);
  }

  /**
   * Compares the specified object with this SignatureAnnImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) SignatureAnnImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        SignatureAnnImpl object = (SignatureAnnImpl) obj;
        if (signature_ != null) {
  ...
  /**
   * Returns the hash code value for this SignatureAnnImpl.
   */
  public int hashCode()
  {
  ...
  {
    SignatureAnnImpl zedObject = null;
    try {
      Signature signature = (Signature) args[0];
      zedObject = new SignatureAnnImpl(getFactory());
