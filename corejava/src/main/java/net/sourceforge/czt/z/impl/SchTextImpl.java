 ...
 */
public abstract class SchTextImpl
  extends TermImpl   implements SchText
{
  /**
  ...
  protected SchTextImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof SchTextVisitor) {
      SchTextVisitor<R> visitor = (SchTextVisitor<R>) v;
