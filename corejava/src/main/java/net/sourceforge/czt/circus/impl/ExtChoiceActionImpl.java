  ...
  extends Action2Impl   implements ExtChoiceAction
{
  ...
  protected ExtChoiceActionImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof ExtChoiceActionVisitor) {
      ExtChoiceActionVisitor<R> visitor = (ExtChoiceActionVisitor<R>) v;
