...
public class ChannelSetImpl
  extends TermImpl   implements ChannelSet
{
  /**
   ...
   */
  protected ChannelSetImpl()
  {
  }

  protected ChannelSetImpl(BaseFactory factory)
  {
    super(factory);
  }
   ...
   * also a(n) ChannelSetImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ChannelSetImpl object = (ChannelSetImpl) obj;
        if (expr_ != null) {
  ...
  public int hashCode()
  {
    ...
    hashCode += "ChannelSetImpl".hashCode();
    if (expr_ != null) {
  ...
  {
    if (v instanceof ChannelSetVisitor) {
      ChannelSetVisitor<R> visitor = (ChannelSetVisitor<R>) v;
      return visitor.visitChannelSet(this);
    }
   ...
   */
  public ChannelSetImpl create(Object[] args)
  {
    ChannelSetImpl zedObject = null;
    try {
      net.sourceforge.czt.z.ast.Expr expr = (net.sourceforge.czt.z.ast.Expr) args[0];
      zedObject = new ChannelSetImpl(getFactory());
