  ...
  extends Action1Impl   implements MuAction
{
   ...
   */
  protected MuActionImpl()
  {
  }

  protected MuActionImpl(BaseFactory factory)
  {
    super(factory);
  }

  /**
   * Compares the specified object with this MuActionImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) MuActionImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        MuActionImpl object = (MuActionImpl) obj;
        if (declName_ != null) {
  ...
  /**
   * Returns the hash code value for this MuActionImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "MuActionImpl".hashCode();
    if (declName_ != null) {
  ...
  {
    if (v instanceof MuActionVisitor) {
      MuActionVisitor<R> visitor = (MuActionVisitor<R>) v;
      return visitor.visitMuAction(this);
    }
   ...
   */
  public MuActionImpl create(Object[] args)
  {
    MuActionImpl zedObject = null;
    try {
      ...
      zedObject = new MuActionImpl(getFactory());
  ...
  {
    Object[] erg = { getCircusAction(), getDeclName() };
    return erg;
  }
