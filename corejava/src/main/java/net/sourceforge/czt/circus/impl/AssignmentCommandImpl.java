...
public class AssignmentCommandImpl
  extends CircusCommandImpl   implements AssignmentCommand
{
  /**
  ...
  protected AssignmentCommandImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof AssignmentCommandVisitor) {
      AssignmentCommandVisitor<R> visitor = (AssignmentCommandVisitor<R>) v;
  ...
  public AssignmentCommandImpl create(Object[] args)
  {
    ...
    try {
      AssignmentPairs assignmentPairs = (AssignmentPairs) args[0];
