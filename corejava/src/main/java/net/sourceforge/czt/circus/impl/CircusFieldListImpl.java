 ...
 * {@link CircusFieldList}.
 *
 * @author Gnast version 0.1
 */

public class CircusFieldListImpl
  extends java.util.AbstractList<Field>
  implements CircusFieldList
{
   ...
   */
  /*@ non_null @*/
  private List<Field> list_ = new ArrayList<Field>();
  ...
  protected CircusFieldListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
  ...
  {
    if (v instanceof CircusFieldListVisitor) {
      CircusFieldListVisitor<R> visitor = (CircusFieldListVisitor<R>) v;
      return visitor.visitCircusFieldList(this);
    }
  ...
  public CircusFieldListImpl create(Object[] args)
  {
    CircusFieldListImpl result = new CircusFieldListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((Field) args[i]);
    }
    return result;
  }
}
