  ...
  extends Action1Impl   implements PrefixingAction
{
  ...
  protected PrefixingActionImpl(BaseFactory factory)
  {
    super(factory);
  }

  /**
   * Compares the specified object with this PrefixingActionImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) PrefixingActionImpl and all the getter methods except getAnns
  ...
  /**
   * Returns the hash code value for this PrefixingActionImpl.
   */
  public int hashCode()
  {
  ...
  {
    if (v instanceof PrefixingActionVisitor) {
      PrefixingActionVisitor<R> visitor = (PrefixingActionVisitor<R>) v;
      return visitor.visitPrefixingAction(this);
    }
   ...
   */
  public PrefixingActionImpl create(Object[] args)
  {
    PrefixingActionImpl zedObject = null;
    try {
      CircusAction circusAction = (CircusAction) args[0];
      Communication communication = (Communication) args[1];
      zedObject = new PrefixingActionImpl(getFactory());
  ...
  {
    Object[] erg = { getCircusAction(), getCommunication() };
    return erg;
  }
