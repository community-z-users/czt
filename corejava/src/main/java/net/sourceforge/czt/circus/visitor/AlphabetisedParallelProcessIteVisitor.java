...
/**
 * A(n) AlphabetisedParallelProcessIte visitor.
 */
public interface AlphabetisedParallelProcessIteVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) AlphabetisedParallelProcessIte.
   * @param  term the AlphabetisedParallelProcessIte to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitAlphabetisedParallelProcessIte(AlphabetisedParallelProcessIte term);
}
