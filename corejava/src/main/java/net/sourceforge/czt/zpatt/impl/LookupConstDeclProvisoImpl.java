  ...
  extends LookupProvisoImpl   implements LookupConstDeclProviso
{
  ...
  protected LookupConstDeclProvisoImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof LookupConstDeclProvisoVisitor) {
      LookupConstDeclProvisoVisitor<R> visitor = (LookupConstDeclProvisoVisitor<R>) v;
   ...
   */
  public LookupConstDeclProvisoImpl create(Object[] args)
  {
    LookupConstDeclProvisoImpl zedObject = null;
    try {
      ...
      zedObject = new LookupConstDeclProvisoImpl(getFactory());
