  ...
  extends BindingImpl   implements JokerPredBinding
{
  ...
  protected JokerPredBindingImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof JokerPredBindingVisitor) {
      JokerPredBindingVisitor<R> visitor = (JokerPredBindingVisitor<R>) v;
   ...
   */
  public JokerPredBindingImpl create(Object[] args)
  {
    JokerPredBindingImpl zedObject = null;
    try {
      JokerPred jokerPred = (JokerPred) args[0];
      net.sourceforge.czt.z.ast.Pred pred = (net.sourceforge.czt.z.ast.Pred) args[1];
      zedObject = new JokerPredBindingImpl(getFactory());
