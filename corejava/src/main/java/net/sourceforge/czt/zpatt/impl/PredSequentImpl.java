  ...
  extends SequentImpl   implements PredSequent
{
  ...
  protected PredSequentImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof PredSequentVisitor) {
      PredSequentVisitor<R> visitor = (PredSequentVisitor<R>) v;
   ...
   */
  public PredSequentImpl create(Object[] args)
  {
    PredSequentImpl zedObject = null;
    try {
      ...
      zedObject = new PredSequentImpl(getFactory());
