  ...
  extends ProvisoImpl   implements CalculateProviso
{
  ...
  protected CalculateProvisoImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof CalculateProvisoVisitor) {
      CalculateProvisoVisitor<R> visitor = (CalculateProvisoVisitor<R>) v;
   ...
   */
  public CalculateProvisoImpl create(Object[] args)
  {
    CalculateProvisoImpl zedObject = null;
    try {
      ...
      zedObject = new CalculateProvisoImpl(getFactory());
