 ...
 */
public interface ClassSig extends Term
{

  /**
   * <p>Returns the Classes elements.</p>
   ...
   */
  net.sourceforge.czt.base.ast.ListTerm<ClassRef> getClasses();
   ...
   */
  net.sourceforge.czt.base.ast.ListTerm<NameSignaturePair> getOperation();
}
