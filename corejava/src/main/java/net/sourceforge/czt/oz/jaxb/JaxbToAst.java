...
public class JaxbToAst extends net.sourceforge.czt.z.jaxb.JaxbToAst
{
  ...
  public Object visitSecondaryDecl(net.sourceforge.czt.oz.jaxb.gen.SecondaryDecl jaxbObject)
  {
    ...
    SecondaryDecl erg = mOzFactory_.createSecondaryDecl(declList);
  ...
  public Object visitClassRefType(net.sourceforge.czt.oz.jaxb.gen.ClassRefType jaxbObject)
  {
    ...
    List primary = new Vector();
    for (Iterator iter = jaxbObject.getPrimary().iterator(); iter.hasNext();) {
      Object obj = iter.next();
      Object o = dispatch(obj);
      primary.add(o);
    }
    ClassRefType erg = mOzFactory_.createClassRefType(classSig, thisClass, superClass, visibilityList, primary);
  ...
  public Object visitClassRef(net.sourceforge.czt.oz.jaxb.gen.ClassRef jaxbObject)
  {
    ...
    ClassRef erg = mOzFactory_.createClassRef(refName, type, newOldPair);
  ...
  public Object visitVisibilityList(net.sourceforge.czt.oz.jaxb.gen.VisibilityList jaxbObject)
  {
    ...
    List zRefName = new Vector();
    for (Iterator iter = jaxbObject.getZRefName().iterator(); iter.hasNext();) {
      Object obj = iter.next();
      Object o = dispatch(obj);
      zRefName.add(o);
    }
    VisibilityList erg = mOzFactory_.createVisibilityList(zRefName);
  ...
  public Object visitHideOpExpr(net.sourceforge.czt.oz.jaxb.gen.HideOpExpr jaxbObject)
  {
    ...
    OpExpr opExpr =
      (OpExpr) dispatch(jaxbObject.getOpExpr());
    net.sourceforge.czt.z.ast.RefNameList refNameList =
      (net.sourceforge.czt.z.ast.RefNameList) dispatch(jaxbObject.getRefNameList());
    HideOpExpr erg = mOzFactory_.createHideOpExpr(opExpr, refNameList);
  ...
  public Object visitNameSignaturePair(net.sourceforge.czt.oz.jaxb.gen.NameSignaturePair jaxbObject)
  {
    ...
    NameSignaturePair erg = mOzFactory_.createNameSignaturePair(declName, signature);
  ...
  public Object visitOpText(net.sourceforge.czt.oz.jaxb.gen.OpText jaxbObject)
  {
    ...
    DeltaList deltaList =
      (DeltaList) dispatch(jaxbObject.getDeltaList());
    net.sourceforge.czt.z.ast.SchText schText =
      (net.sourceforge.czt.z.ast.SchText) dispatch(jaxbObject.getSchText());
    OpText erg = mOzFactory_.createOpText(deltaList, schText);
  ...
  public Object visitDeltaList(net.sourceforge.czt.oz.jaxb.gen.DeltaList jaxbObject)
  {
    ...
    DeltaList erg = mOzFactory_.createDeltaList(refName);
  ...
  public Object visitState(net.sourceforge.czt.oz.jaxb.gen.State jaxbObject)
  {
    ...
    PrimaryDecl primaryDecl =
      (PrimaryDecl) dispatch(jaxbObject.getPrimaryDecl());
    SecondaryDecl secondaryDecl =
      (SecondaryDecl) dispatch(jaxbObject.getSecondaryDecl());
    ...
    if (boxJaxb != null) {
      box =
        net.sourceforge.czt.z.ast.Box.fromString(boxJaxb);
    }
    State erg = mOzFactory_.createState(primaryDecl, secondaryDecl, pred, box);
  ...
  public Object visitOpPromotionExpr(net.sourceforge.czt.oz.jaxb.gen.OpPromotionExpr jaxbObject)
  {
    ...
    net.sourceforge.czt.z.ast.RefName refName =
      (net.sourceforge.czt.z.ast.RefName) dispatch(jaxbObject.getRefName());
    OpPromotionExpr erg = mOzFactory_.createOpPromotionExpr(expr, refName);
  ...
  public Object visitClassPara(net.sourceforge.czt.oz.jaxb.gen.ClassPara jaxbObject)
  {
    ...
    ClassPara erg = mOzFactory_.createClassPara(declName, formalParameters, visibilityList, inheritedClass, localDef, state, initialState, operation);
  ...
  public Object visitOperation(net.sourceforge.czt.oz.jaxb.gen.Operation jaxbObject)
  {
    ...
    net.sourceforge.czt.z.ast.DeclName opName =
      (net.sourceforge.czt.z.ast.DeclName) dispatch(jaxbObject.getOpName());
    OpExpr opExpr =
      (OpExpr) dispatch(jaxbObject.getOpExpr());
    net.sourceforge.czt.z.ast.Box box = null;
    String boxJaxb = jaxbObject.getBox();
    ...
    Operation erg = mOzFactory_.createOperation(opName, opExpr, box);
  ...
  public Object visitInitialState(net.sourceforge.czt.oz.jaxb.gen.InitialState jaxbObject)
  {
    ...
    InitialState erg = mOzFactory_.createInitialState(pred, box);
  ...
  public Object visitPrimaryDecl(net.sourceforge.czt.oz.jaxb.gen.PrimaryDecl jaxbObject)
  {
    ...
    net.sourceforge.czt.z.ast.DeclList declList =
      (net.sourceforge.czt.z.ast.DeclList) dispatch(jaxbObject.getDeclList());
    PrimaryDecl erg = mOzFactory_.createPrimaryDecl(declList);
  ...
  public Object visitRenameOpExpr(net.sourceforge.czt.oz.jaxb.gen.RenameOpExpr jaxbObject)
  {
    ...
    RenameOpExpr erg = mOzFactory_.createRenameOpExpr(opExpr, renameList);
