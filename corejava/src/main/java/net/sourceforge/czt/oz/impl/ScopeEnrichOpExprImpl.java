...
public class ScopeEnrichOpExprImpl
  extends OpExpr2Impl   implements ScopeEnrichOpExpr
{
  /**
  ...
  protected ScopeEnrichOpExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ScopeEnrichOpExprVisitor) {
      ScopeEnrichOpExprVisitor<R> visitor = (ScopeEnrichOpExprVisitor<R>) v;
   ...
   */
  public ScopeEnrichOpExprImpl create(Object[] args)
  {
    ScopeEnrichOpExprImpl zedObject = null;
    try {
      OpExpr leftOpExpr = (OpExpr) args[0];
      OpExpr rightOpExpr = (OpExpr) args[1];
      zedObject = new ScopeEnrichOpExprImpl(getFactory());
