...
public class ParallelOpExprImpl
  extends OpExpr2Impl   implements ParallelOpExpr
{
  /**
  ...
  protected ParallelOpExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ParallelOpExprVisitor) {
      ParallelOpExprVisitor<R> visitor = (ParallelOpExprVisitor<R>) v;
   ...
   */
  public ParallelOpExprImpl create(Object[] args)
  {
    ParallelOpExprImpl zedObject = null;
    try {
      OpExpr leftOpExpr = (OpExpr) args[0];
      OpExpr rightOpExpr = (OpExpr) args[1];
      zedObject = new ParallelOpExprImpl(getFactory());
