...
public class DistConjOpExprImpl
  extends DistOpExprImpl   implements DistConjOpExpr
{
  /**
  ...
  protected DistConjOpExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof DistConjOpExprVisitor) {
      DistConjOpExprVisitor<R> visitor = (DistConjOpExprVisitor<R>) v;
   ...
   */
  public DistConjOpExprImpl create(Object[] args)
  {
    DistConjOpExprImpl zedObject = null;
    try {
      net.sourceforge.czt.z.ast.SchText schText = (net.sourceforge.czt.z.ast.SchText) args[0];
      OpExpr opExpr = (OpExpr) args[1];
      zedObject = new DistConjOpExprImpl(getFactory());
