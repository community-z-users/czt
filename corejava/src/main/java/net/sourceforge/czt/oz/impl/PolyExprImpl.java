  ...
  extends Expr1Impl   implements PolyExpr
{
  ...
  protected PolyExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof PolyExprVisitor) {
      PolyExprVisitor<R> visitor = (PolyExprVisitor<R>) v;
   ...
   */
  public PolyExprImpl create(Object[] args)
  {
    PolyExprImpl zedObject = null;
    try {
      Expr expr = (Expr) args[0];
      zedObject = new PolyExprImpl(getFactory());
