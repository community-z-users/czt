...
public class InitialStateImpl
  extends TermImpl   implements InitialState
{
  /**
  ...
  protected InitialStateImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof InitialStateVisitor) {
      InitialStateVisitor<R> visitor = (InitialStateVisitor<R>) v;
   ...
   */
  public InitialStateImpl create(Object[] args)
  {
    InitialStateImpl zedObject = null;
    try {
      net.sourceforge.czt.z.ast.Pred pred = (net.sourceforge.czt.z.ast.Pred) args[0];
      net.sourceforge.czt.z.ast.Box box = (net.sourceforge.czt.z.ast.Box) args[1];
      zedObject = new InitialStateImpl(getFactory());
