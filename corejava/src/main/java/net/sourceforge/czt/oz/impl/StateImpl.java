...
public class StateImpl
  extends TermImpl   implements State
{
  /**
  ...
  protected StateImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof StateVisitor) {
      StateVisitor<R> visitor = (StateVisitor<R>) v;
  ...
  public StateImpl create(Object[] args)
  {
    ...
    try {
      PrimaryDecl primaryDecl = (PrimaryDecl) args[0];
      SecondaryDecl secondaryDecl = (SecondaryDecl) args[1];
      net.sourceforge.czt.z.ast.Pred pred = (net.sourceforge.czt.z.ast.Pred) args[2];
      net.sourceforge.czt.z.ast.Box box = (net.sourceforge.czt.z.ast.Box) args[3];
