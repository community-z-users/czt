 ...
 */
public interface NameSignaturePair extends Term
{
   ...
   */
  net.sourceforge.czt.z.ast.Signature getSignature();
   ...
   * @see #getSignature
   */
  void setSignature(net.sourceforge.czt.z.ast.Signature signature);
  /**
