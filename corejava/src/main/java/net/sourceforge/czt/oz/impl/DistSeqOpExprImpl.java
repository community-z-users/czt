  ...
  extends DistOpExprImpl   implements DistSeqOpExpr
{
  ...
  protected DistSeqOpExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof DistSeqOpExprVisitor) {
      DistSeqOpExprVisitor<R> visitor = (DistSeqOpExprVisitor<R>) v;
   ...
   */
  public DistSeqOpExprImpl create(Object[] args)
  {
    DistSeqOpExprImpl zedObject = null;
    try {
      net.sourceforge.czt.z.ast.SchText schText = (net.sourceforge.czt.z.ast.SchText) args[0];
      OpExpr opExpr = (OpExpr) args[1];
      zedObject = new DistSeqOpExprImpl(getFactory());
