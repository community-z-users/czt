  ...
  extends OpExpr2Impl   implements SynPllProExpr
{
  ...
  protected SynPllProExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof SynPllProExprVisitor) {
      SynPllProExprVisitor<R> visitor = (SynPllProExprVisitor<R>) v;
   ...
   */
  public SynPllProExprImpl create(Object[] args)
  {
    SynPllProExprImpl zedObject = null;
    try {
      OpExpr leftOpExpr = (OpExpr) args[0];
      OpExpr rightOpExpr = (OpExpr) args[1];
      EventSet events = (EventSet) args[2];
      zedObject = new SynPllProExprImpl(getFactory());
