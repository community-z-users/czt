...
import net.sourceforge.czt.tcoz.visitor.InterruptTimeOpExprVisitor;

/**
 * An implementation of the interface
 * {@link InterruptTimeOpExpr}.
 *
 * @author Gnast version 0.1
 */
public class InterruptTimeOpExprImpl
  extends OpExprImpl   implements InterruptTimeOpExpr
{
  /**
   ...
   */
  protected InterruptTimeOpExprImpl()
  {
  }

  protected InterruptTimeOpExprImpl(BaseFactory factory)
  {
    super(factory);
  }

  /**
   * Compares the specified object with this InterruptTimeOpExprImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) InterruptTimeOpExprImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        InterruptTimeOpExprImpl object = (InterruptTimeOpExprImpl) obj;
        if (normalOp_ != null) {
  ...
  public int hashCode()
  {
    ...
    hashCode += "InterruptTimeOpExprImpl".hashCode();
    if (normalOp_ != null) {
  ...
  {
    if (v instanceof InterruptTimeOpExprVisitor) {
      InterruptTimeOpExprVisitor<R> visitor = (InterruptTimeOpExprVisitor<R>) v;
      return visitor.visitInterruptTimeOpExpr(this);
    }
   ...
   */
  public InterruptTimeOpExprImpl create(Object[] args)
  {
    InterruptTimeOpExprImpl zedObject = null;
    try {
      ...
      zedObject = new InterruptTimeOpExprImpl(getFactory());
