...
import net.sourceforge.czt.tcoz.visitor.InterruptProExprVisitor;

/**
 * An implementation of the interface
 * {@link InterruptProExpr}.
 *
  ...
  extends OpExprImpl   implements InterruptProExpr
{
   ...
   */
  protected InterruptProExprImpl()
  {
  }

  protected InterruptProExprImpl(BaseFactory factory)
  {
    super(factory);
  }

  /**
   * Compares the specified object with this InterruptProExprImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) InterruptProExprImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        InterruptProExprImpl object = (InterruptProExprImpl) obj;
        if (normalOp_ != null) {
  ...
  /**
   * Returns the hash code value for this InterruptProExprImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "InterruptProExprImpl".hashCode();
    if (normalOp_ != null) {
  ...
  {
    if (v instanceof InterruptProExprVisitor) {
      InterruptProExprVisitor<R> visitor = (InterruptProExprVisitor<R>) v;
      return visitor.visitInterruptProExpr(this);
    }
   ...
   */
  public InterruptProExprImpl create(Object[] args)
  {
    InterruptProExprImpl zedObject = null;
    try {
      ...
      zedObject = new InterruptProExprImpl(getFactory());
