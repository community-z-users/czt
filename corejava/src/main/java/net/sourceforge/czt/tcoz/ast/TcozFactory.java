  ...
  extends net.sourceforge.czt.oz.ast.OzFactory
{
   ...
   * @return the new instance of Connection.
   */
  Connection createConnection(java.util.List<? extends net.sourceforge.czt.z.ast.RefName>
 ...
 channels);
   ...
   * @return the new instance of EventSet.
   */
  EventSet createEventSet(java.util.List<? extends net.sourceforge.czt.z.ast.Expr>
 event);
   ...
   * @return the new instance of Event.
   */
  Event createEvent( net.sourceforge.czt.z.ast.RefName  channelName, net.sourceforge.czt.z.ast.Expr  expr);
   ...
   * @return the new instance of TopologyProExpr.
   */
  TopologyProExpr createTopologyProExpr(java.util.List<? extends Connection>
 connection);
