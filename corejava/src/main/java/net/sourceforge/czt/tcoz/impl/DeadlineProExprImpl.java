  ...
  extends OpExprImpl   implements DeadlineProExpr
{
  ...
  protected DeadlineProExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof DeadlineProExprVisitor) {
      DeadlineProExprVisitor<R> visitor = (DeadlineProExprVisitor<R>) v;
   ...
   */
  public DeadlineProExprImpl create(Object[] args)
  {
    DeadlineProExprImpl zedObject = null;
    try {
      ...
      zedObject = new DeadlineProExprImpl(getFactory());
