  ...
  extends ExprImpl   implements ChannelExpr
{
  ...
  protected ChannelExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ChannelExprVisitor) {
      ChannelExprVisitor<R> visitor = (ChannelExprVisitor<R>) v;
   ...
   */
  public ChannelExprImpl create(Object[] args)
  {
    ChannelExprImpl zedObject = null;
    try {
      zedObject = new ChannelExprImpl(getFactory());
    }
