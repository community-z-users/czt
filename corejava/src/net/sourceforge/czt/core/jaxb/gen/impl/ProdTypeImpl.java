...
public class ProdTypeImpl
    ...
    implements net.sourceforge.czt.core.jaxb.gen.ProdType, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.zpatt.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.zpatt.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.zpatt.jaxb.gen.impl.runtime.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Type.get(idx1) instanceof net.sourceforge.czt.core.jaxb.gen.Type) {
                if (_Type.get(idx1) instanceof javax.xml.bind.Element) {
                    ...
                    int idx_0 = idx1;
                    context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Type.get(idx_0 ++)));
                    context.endNamespaceDecls();
                    int idx_1 = idx1;
                    context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Type.get(idx_1 ++)));
                    context.endAttributes();
                    context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Type.get(idx1 ++)));
                    context.endElement();
                }
            } else {
                if (_Type.get(idx1) instanceof net.sourceforge.czt.core.jaxb.gen.GenTypeElement) {
                    context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Type.get(idx1 ++)));
                } else {
                    if (_Type.get(idx1) instanceof net.sourceforge.czt.core.jaxb.gen.ProdTypeElement) {
                        context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Type.get(idx1 ++)));
                    } else {
                        if (_Type.get(idx1) instanceof net.sourceforge.czt.core.jaxb.gen.PowerTypeElement) {
                            context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Type.get(idx1 ++)));
                        } else {
                            if (_Type.get(idx1) instanceof net.sourceforge.czt.core.jaxb.gen.SchemaTypeElement) {
                                context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Type.get(idx1 ++)));
                            } else {
                                if (_Type.get(idx1) instanceof net.sourceforge.czt.core.jaxb.gen.GivenTypeElement) {
                                    context.childAsElementBody(((com.sun.xml.bind.JAXBObject) _Type.get(idx1 ++)));
                                } else {
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0017\u00cfm\u00cbppsq\u0000~\u0000\u0000\u0010^\u009bxppsq\u0000~\u0000\u0000\b"
+"\u00ed\u00c93ppsr\u0000\u001dcom.sun.msv.grammar.ChoiceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001\u0001|\u00f6\u00eep"
...
+"\u0004Annst\u0000\u001ehttp://czt.sourceforge.net/zmlq\u0000~\u0000\u001esq\u0000~\u0000\b\u0007p\u00d2@ppsq\u0000~\u0000"
...
+"~\u0000\u001ft\u00001net.sourceforge.czt.core.jaxb.gen.ProdTypeElementq\u0000~\u0000#"
+"sq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~"
+"\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u00002net.sourceforge.czt.core.jaxb.gen.Power"
+"TypeElementq\u0000~\u0000#sq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000"
+"~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u00003net.sourceforge.czt.cor"
+"e.jaxb.gen.SchemaTypeElementq\u0000~\u0000#sq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq"
+"\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u00002net.so"
+"urceforge.czt.core.jaxb.gen.GivenTypeElementq\u0000~\u0000#sq\u0000~\u0000\b\u0007p\u00d2@p"
+"psq\u0000~\u0000\b\u0005\u00f3\u00dbfppsq\u0000~\u0000\b\u0004v\u00e4\u008cppsq\u0000~\u0000\b\u0002\u00f9\u00ed\u00b2ppsq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cd"
+"ppsq\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u00000"
+"q\u0000~\u0000#sq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000"
+"\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u00006q\u0000~\u0000#sq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq"
+"\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u0000<q\u0000~\u0000"
+"#sq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000"
+"~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u0000Bq\u0000~\u0000#sq\u0000~\u0000\n\u0001|\u00f6\u00d8pp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq\u0000~\u0000\u0012"
+"\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u0000Hq\u0000~\u0000#sq\u0000"
+"~\u0000\b\u0007p\u00d2Nppsq\u0000~\u0000\u0012\u0007p\u00d2Cq\u0000~\u0000\u000fpsq\u0000~\u0000\b\u0007p\u00d2@q\u0000~\u0000\u000fpsq\u0000~\u0000\b\u0005\u00f3\u00dbfq\u0000~\u0000\u000fpsq\u0000"
+"~\u0000\b\u0004v\u00e4\u008cq\u0000~\u0000\u000fpsq\u0000~\u0000\b\u0002\u00f9\u00ed\u00b2q\u0000~\u0000\u000fpsq\u0000~\u0000\n\u0001|\u00f6\u00d8q\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq"
+"\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u00000q\u0000~\u0000"
+"#sq\u0000~\u0000\n\u0001|\u00f6\u00d8q\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cdppsq\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000"
+"\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u00006q\u0000~\u0000#sq\u0000~\u0000\n\u0001|\u00f6\u00d8q\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\b\u0001|\u00f6\u00cd"
+"ppsq\u0000~\u0000\u0012\u0001|\u00f6\u00c2q\u0000~\u0000\u000fpsq\u0000~\u0000\u0015\u0001|\u00f6\u00bfq\u0000~\u0000\u000fpq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u0000<"
...
+".Expression;\u00d68D\u00c3]\u00ad\u00a7\n\u0002\u0000\u0000xp\u0000\u0000\u0000\u00bfpppppppppppppppq\u0000~\u0000\'q\u0000~\u0000Iq\u0000~\u0000hq"
+"\u0000~\u0000gppq\u0000~\u0000\u0005pppppppq\u0000~\u0000fpppppppppppppq\u0000~\u0000*q\u0000~\u0000Lq\u0000~\u0000kppppppppp"
+"pppppppppppppppppppppppppppppppppq\u0000~\u0000(q\u0000~\u0000Jq\u0000~\u0000ipppq\u0000~\u0000\u0014q\u0000~\u0000"
+"-q\u0000~\u00003q\u0000~\u00009q\u0000~\u0000?q\u0000~\u0000Eq\u0000~\u0000Oq\u0000~\u0000Tq\u0000~\u0000Yq\u0000~\u0000^q\u0000~\u0000cq\u0000~\u0000\u0011q\u0000~\u0000,q\u0000~\u0000"
+"2q\u0000~\u00008q\u0000~\u0000>q\u0000~\u0000Dq\u0000~\u0000Nq\u0000~\u0000Sq\u0000~\u0000Xq\u0000~\u0000]q\u0000~\u0000bq\u0000~\u0000nq\u0000~\u0000mq\u0000~\u0000sq\u0000~\u0000"
+"rq\u0000~\u0000xq\u0000~\u0000wq\u0000~\u0000}q\u0000~\u0000|q\u0000~\u0000\u0082q\u0000~\u0000\u0081ppppppppppppq\u0000~\u0000\tpppppppppppp"
+"pppppppq\u0000~\u0000\u0007ppq\u0000~\u0000)q\u0000~\u0000Kq\u0000~\u0000jppppppppppppppq\u0000~\u0000\u0006pppppppppppp"));
        }
