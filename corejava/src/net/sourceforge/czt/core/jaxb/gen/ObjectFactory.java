    ...
    extends net.sourceforge.czt.core.jaxb.gen.impl.runtime.DefaultJAXBContextImpl
{
        ...
        extends net.sourceforge.czt.core.jaxb.gen.impl.runtime.AbstractGrammarInfoImpl
    {
        ...
        public java.lang.String[] getProbePoints() {
            return new java.lang.String[] {"http://czt.sourceforge.net/zml", "Spec", "http://czt.sourceforge.net/zml", "SchExpr", "http://czt.sourceforge.net/zml", "ImpliesPred", "http://czt.sourceforge.net/zml", "GivenPara", "http://czt.sourceforge.net/zml", "ImpliesExpr", "http://czt.sourceforge.net/zml", "Name", "http://czt.sourceforge.net/zml", "NameSectTypeTriple", "http://czt.sourceforge.net/zml", "TupleExpr", "http://czt.sourceforge.net/zml", "IffPred", "http://czt.sourceforge.net/zml", "ProdExpr", "http://czt.sourceforge.net/zml", "TruePred", "http://czt.sourceforge.net/zml", "NextStroke", "http://czt.sourceforge.net/zml", "PreExpr", "http://czt.sourceforge.net/zml", "LetExpr", "http://czt.sourceforge.net/zml", "Exists1Pred", "http://czt.sourceforge.net/zml", "PipeExpr", "http://czt.sourceforge.net/zml", "VarDecl", "http://czt.sourceforge.net/zml", "ExprPred", "http://czt.sourceforge.net/zml", "FalsePred", "http://czt.sourceforge.net/zml", "RenameExpr", "http://czt.sourceforge.net/zml", "SchemaType", "http://czt.sourceforge.net/zml", "TypeEnvAnn", "http://czt.sourceforge.net/zml", "RefName", "http://czt.sourceforge.net/zml", "SectTypeEnvAnn", "http://czt.sourceforge.net/zml", "Exists1Expr", "http://czt.sourceforge.net/zml", "ApplExpr", "http://czt.sourceforge.net/zml", "BindExpr", "http://czt.sourceforge.net/zml", "ProjExpr", "http://czt.sourceforge.net/zml", "NarrPara", "http://czt.sourceforge.net/zml", "BindSelExpr", "http://czt.sourceforge.net/zml", "LambdaExpr", "http://czt.sourceforge.net/zml", "ZSect", "http://czt.sourceforge.net/zml", "InStroke", "http://czt.sourceforge.net/zml", "Signature", "http://czt.sourceforge.net/zml", "FreePara", "http://czt.sourceforge.net/zml", "ExistsPred", "http://czt.sourceforge.net/zml", "NumExpr", "http://czt.sourceforge.net/zml", "NameTypePair", "http://czt.sourceforge.net/zml", "ExistsExpr", "http://czt.sourceforge.net/zml", "AxPara", "http://czt.sourceforge.net/zml", "PowerType", "http://czt.sourceforge.net/zml", "UnparsedPara", "http://czt.sourceforge.net/zml", "SetExpr", "http://czt.sourceforge.net/zml", "ForallPred", "http://czt.sourceforge.net/zml", "ThetaExpr", "http://czt.sourceforge.net/zml", "GenType", "http://czt.sourceforge.net/zml", "HideExpr", "http://czt.sourceforge.net/zml", "NegExpr", "http://czt.sourceforge.net/zml", "ForallExpr", "http://czt.sourceforge.net/zml", "Operand", "http://czt.sourceforge.net/zml", "Freetype", "http://czt.sourceforge.net/zml", "InclDecl", "http://czt.sourceforge.net/zml", "NameNamePair", "http://czt.sourceforge.net/zml", "NarrSect", "http://czt.sourceforge.net/zml", "OutStroke", "http://czt.sourceforge.net/zml", "RefExpr", "http://czt.sourceforge.net/zml", "SchText", "http://czt.sourceforge.net/zml", "PowerExpr", "http://czt.sourceforge.net/zml", "TupleSelExpr", "http://czt.sourceforge.net/zml", "UnparsedZSect", "http://czt.sourceforge.net/zml", "NameExprPair", "http://czt.sourceforge.net/zml", "ConjPara", "http://czt.sourceforge.net/zml", "IffExpr", "http://czt.sourceforge.net/zml", "ProdType", "http://czt.sourceforge.net/zml", "DecorExpr", "http://czt.sourceforge.net/zml", "MuExpr", "http://czt.sourceforge.net/zml", "CondExpr", "http://czt.sourceforge.net/zml", "GivenType", "http://czt.sourceforge.net/zml", "DeclName", "http://czt.sourceforge.net/zml", "Branch", "http://czt.sourceforge.net/zml", "Parent", "http://czt.sourceforge.net/zml", "NumStroke", "http://czt.sourceforge.net/zml", "SetCompExpr", "http://czt.sourceforge.net/zml", "OptempPara", "http://czt.sourceforge.net/zml", "AndPred", "http://czt.sourceforge.net/zml", "CompExpr", "http://czt.sourceforge.net/zml", "OrExpr", "http://czt.sourceforge.net/zml", "LocAnn", "http://czt.sourceforge.net/zml", "ParenAnn", "http://czt.sourceforge.net/zml", "TypeAnn", "http://czt.sourceforge.net/zml", "ConstDecl", "http://czt.sourceforge.net/zml", "AndExpr", "http://czt.sourceforge.net/zml", "NegPred", "http://czt.sourceforge.net/zml", "MemPred", "http://czt.sourceforge.net/zml", "OrPred"};
        }
