...
extends QntPredImpl implements Exists1Pred
{
  private static final Logger sLogger =
    Logger.getLogger("net.sourceforge.czt.core.impl.Exists1PredImpl");
   ...
   * also a(n) Exists1PredImpl and all the getter methods except getAnns
  ...
  /**
   * Returns the hash code value for this Exists1PredImpl.
   * The hash code of a Exists1PredImpl is defined to be
  ...
  public Term create(Object[] args) {
    ...
    sLogger.entering("Exists1PredImpl", "create", zedObject);
    return zedObject;
  }

  public Object[] getChildren()
  {
    sLogger.entering("Exists1PredImpl", "getChildren");
    Object[] erg = { getSchText(), getPred() };
    sLogger.exiting("Exists1PredImpl", "getChildren", erg);
    return erg;
  }
}
