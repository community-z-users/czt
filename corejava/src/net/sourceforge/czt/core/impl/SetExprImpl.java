...
import net.sourceforge.czt.core.visitor.SetExprVisitor;
...
extends Expr0NImpl implements SetExpr
{
  private static final Logger sLogger =
    Logger.getLogger("net.sourceforge.czt.core.impl.SetExprImpl");
   ...
   * also a(n) SetExprImpl and all the getter methods except getAnns
  ...
  /**
   * Returns the hash code value for this SetExprImpl.
   * The hash code of a SetExprImpl is defined to be
  ...
  public net.sourceforge.czt.zed.ast.Term create(Object[] args) {
    sLogger.entering("SetExprImpl", "create", args);
  ...
  {
    sLogger.entering("SetExprImpl", "getChildren");
    Object[] erg = { getExpr() };
    sLogger.exiting("SetExprImpl", "getChildren", erg);
    return erg;
  }
}
