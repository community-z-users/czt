...
import net.sourceforge.czt.core.visitor.PowerExprVisitor;
...
extends Expr1Impl implements PowerExpr
{
  private static final Logger sLogger =
    Logger.getLogger("net.sourceforge.czt.core.impl.PowerExprImpl");
   ...
   * also a(n) PowerExprImpl and all the getter methods except getAnns
  ...
  /**
   * Returns the hash code value for this PowerExprImpl.
   * The hash code of a PowerExprImpl is defined to be
  ...
  public net.sourceforge.czt.zed.ast.Term create(Object[] args) {
    sLogger.entering("PowerExprImpl", "create", args);
    PowerExpr zedObject = null;
    try {
      Expr expr = (Expr) args[0];
      zedObject = new PowerExprImpl();
  ...
  {
    sLogger.entering("PowerExprImpl", "getChildren");
    Object[] erg = { getExpr() };
    sLogger.exiting("PowerExprImpl", "getChildren", erg);
    return erg;
  }
}
