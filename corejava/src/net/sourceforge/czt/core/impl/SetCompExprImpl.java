...
extends QntExprImpl implements SetCompExpr
{
  private static final Logger sLogger =
    Logger.getLogger("net.sourceforge.czt.core.impl.SetCompExprImpl");
   ...
   * The hash code of a SetCompExprImpl is defined to be
  ...
  {
    sLogger.entering("SetCompExprImpl", "getChildren");
    Object[] erg = { getSchText(), getExpr() };
    sLogger.exiting("SetCompExprImpl", "getChildren", erg);
    return erg;
  }
}
