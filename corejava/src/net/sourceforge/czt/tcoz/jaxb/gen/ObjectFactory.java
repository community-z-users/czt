    ...
    extends net.sourceforge.czt.core.jaxb.gen.impl.runtime.DefaultJAXBContextImpl
{
    ...
    public final static net.sourceforge.czt.core.jaxb.gen.impl.runtime.GrammarInfo grammarInfo = new net.sourceforge.czt.core.jaxb.gen.impl.runtime.GrammarInfoImpl(rootTagMap, defaultImplementations, (net.sourceforge.czt.tcoz.jaxb.gen.ObjectFactory.class));
    ...
    static {
        ...
        defaultImplementations.put((net.sourceforge.czt.tcoz.jaxb.gen.GuardProExpr.class), "net.sourceforge.czt.tcoz.jaxb.gen.impl.GuardProExprImpl");
        ...
        defaultImplementations.put((net.sourceforge.czt.tcoz.jaxb.gen.GuardProExprElement.class), "net.sourceforge.czt.tcoz.jaxb.gen.impl.GuardProExprElementImpl");
        ...
        rootTagMap.put(new javax.xml.namespace.QName("http://czt.sourceforge.net/tcoz", "GuardProExpr"), (net.sourceforge.czt.tcoz.jaxb.gen.GuardProExprElement.class));
    ...
    /**
     * Create an instance of GuardProExprElement
     * 
     * @throws JAXBException
     *     if an error occurs
     */
    public net.sourceforge.czt.tcoz.jaxb.gen.GuardProExprElement createGuardProExprElement()
        throws javax.xml.bind.JAXBException
    {
        return new net.sourceforge.czt.tcoz.jaxb.gen.impl.GuardProExprElementImpl();
    }
