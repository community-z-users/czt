 ...
 * @version $Revision$
 */
class GrammarInfoFacade extends AbstractGrammarInfoImpl {
    ...
    static GrammarInfo createGrammarInfoFacade( String contextPath, 
        ...
        while( st.hasMoreTokens() ) {
            ...
            try {
                ...
                Object grammarInfo;
                try {
                    grammarInfo = c.getClass().getMethod(
                        "getGrammarInfo", new Class[0]).invoke(c, new Object[0]);
                } catch( InvocationTargetException e ) {
                    throw new JAXBException(e.getTargetException());
                }
    ...
    private static String getVersion(JAXBContext c) throws JAXBException {
        try {
            Class versionClass = (Class)c.getClass().getField("version").get(null);
            return (String)versionClass.getField("version").get(null);
        } catch( Throwable t ) {
            return null;
        }
    }
