...
public class SAXMarshaller implements XMLSerializer
{
    ...
    public SAXMarshaller( ContentHandler _writer, NamespacePrefixMapper prefixMapper, MarshallerImpl _owner ) {
        this.writer = _writer;
        this.owner = _owner;
        this.nsContext = new NamespaceContextImpl(prefixMapper);
    }
    ...
    public void childAsElementBody( JAXBObject o ) throws SAXException {
        if(o==null) {
        ...
        Util.toXMLSerializable(o).serializeElementBody(this);
    }
    
    public void childAsAttributes( JAXBObject o ) throws SAXException {
        if(o==null) {
            missingObjectError();
            return;
        }
        Util.toXMLSerializable(o).serializeAttributes(this);
    }
    
    public void childAsAttributeBody( JAXBObject o ) throws SAXException {
        if(o==null) {
            missingObjectError();
            return;
        }
        Util.toXMLSerializable(o).serializeAttributeBody(this);
    }
    
    public void childAsURIs( JAXBObject o ) throws SAXException {
        if(o==null) {
            missingObjectError();
            return;
        }
        Util.toXMLSerializable(o).serializeURIs(this);
    }
