 ...
 */
public interface Name extends TermA
{
  ...
  /**
   * Returns the name, that is the string representation, of this name.
   * The name is the word with all the strokes appended at the end.
   */
  String getName();
