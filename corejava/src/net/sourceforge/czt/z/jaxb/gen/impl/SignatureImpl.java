                ...
                switch (state) {
                    case  2 :
                        if (("Name" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getNameTypePair().add(((net.sourceforge.czt.z.jaxb.gen.impl.NameTypePairImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.NameTypePairImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
                        ...
                        if (("NameTypePair" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getNameTypePair().add(((net.sourceforge.czt.z.jaxb.gen.impl.NameTypePairElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.NameTypePairElementImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        state = 1;
                        continue outer;
