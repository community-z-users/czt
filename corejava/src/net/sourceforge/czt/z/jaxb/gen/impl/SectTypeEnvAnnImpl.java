            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        if (("NameSectTypeTriple" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getNameSectTypeTriple().add(((net.sourceforge.czt.z.jaxb.gen.impl.NameSectTypeTripleElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.NameSectTypeTripleElementImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                    ...
                    case  3 :
                        if (("Name" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getNameSectTypeTriple().add(((net.sourceforge.czt.z.jaxb.gen.impl.NameSectTypeTripleImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.NameSectTypeTripleImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
