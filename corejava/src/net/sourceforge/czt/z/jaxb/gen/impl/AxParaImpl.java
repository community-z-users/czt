...
+"Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u001c\u0001pq\u0000~\u0000%q\u0000~\u0000Rq\u0000~\u0000kq"
+"\u0000~\u0000\u0006q\u0000~\u0000Aq\u0000~\u0000\tq\u0000~\u0000Cq\u0000~\u0000\\q\u0000~\u0000\u0010q\u0000~\u0000Kq\u0000~\u0000dq\u0000~\u0000Bq\u0000~\u0000\u0005q\u0000~\u0000\u0015q\u0000~\u0000Fq"
+"\u0000~\u0000Nq\u0000~\u0000Xq\u0000~\u0000_q\u0000~\u0000gq\u0000~\u0000@q\u0000~\u0000oq\u0000~\u0000\u0012q\u0000~\u0000Eq\u0000~\u0000Mq\u0000~\u0000Wq\u0000~\u0000\u0007q\u0000~\u0000^q"
+"\u0000~\u0000fx"));
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromLeaveElement((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  8 :
                        if (("DeclName" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  7 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 8, ___uri, ___local, ___qname)));
                            return ;
                        }
                        _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromLeaveAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  6 :
                ...
                try {
                    switch (state) {
                        ...
                        case  7 :
                            ...
                            _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromText((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 8, value)));
                            return ;
                        case  6 :
