            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromLeaveElement((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 4, ___uri, ___local, ___qname)));
                        return ;
                    case  2 :
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 4, ___uri, ___local, ___qname)));
                            return ;
                        }
                        _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 4, ___uri, ___local, ___qname)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromLeaveAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 4, ___uri, ___local, ___qname)));
                        return ;
                    case  2 :
                ...
                try {
                    switch (state) {
                        ...
                        case  3 :
                            ...
                            _getDeclName().add(((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl) spawnChildFromText((net.sourceforge.czt.z.jaxb.gen.impl.DeclNameImpl.class), 4, value)));
                            return ;
                        case  2 :
