...
public class GivenTypeImpl
    ...
    implements net.sourceforge.czt.z.jaxb.gen.GivenType, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.oz.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.oz.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.oz.jaxb.gen.impl.runtime.ValidatableObject
{
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0006\u00aa\u00fb\u0017ppsr\u0000\u001dcom.sun.msv.gra"
+"mmar.ChoiceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001\u0003sgsppsr\u0000\'com.sun.msv.grammar"
+".trex.ElementPattern\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\tnameClasst\u0000\u001fLcom/sun/msv/g"
+"rammar/NameClass;xr\u0000\u001ecom.sun.msv.grammar.ElementExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
+"\u0000\u0002Z\u0000\u001aignoreUndeclaredAttributesL\u0000\fcontentModelq\u0000~\u0000\u0002xq\u0000~\u0000\u0003\u0003sg"
+"hsr\u0000\u0011java.lang.Boolean\u00cd r\u0080\u00d5\u009c\u00fa\u00ee\u0002\u0000\u0001Z\u0000\u0005valuexp\u0000p\u0000sq\u0000~\u0000\u0000\u0003sg]ppsq"
...
+"/java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0006\u0002\u000e\u00ef]ppsq\u0000~\u0000\u0014\u0002\u000e\u00efRq"
...
+"forge.net/zmlq\u0000~\u0000\u001dsq\u0000~\u0000\b\u00037\u0093\u009fpp\u0000sq\u0000~\u0000\u0000\u00037\u0093\u0094ppsq\u0000~\u0000\b\u0001dw\u00fbpp\u0000sq\u0000~"
+"\u0000\u0006\u0001dw\u00f0ppsq\u0000~\u0000\u0011\u0001dw\u00e5q\u0000~\u0000\rpsq\u0000~\u0000\u0014\u0001dw\u00e2q\u0000~\u0000\rpq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000"
+"\u001et\u0000\'net.sourceforge.czt.z.jaxb.gen.DeclNameq\u0000~\u0000\"sq\u0000~\u0000\u0006\u0001\u00d3\u001b\u0094pp"
+"sq\u0000~\u0000\u0014\u0001\u00d3\u001b\u0089q\u0000~\u0000\rpq\u0000~\u0000(sq\u0000~\u0000\u001eq\u0000~\u00009q\u0000~\u0000:q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0004Nameq\u0000~\u0000="
...
+"D\u00c3]\u00ad\u00a7\n\u0002\u0000\u0000xp\u0000\u0000\u0000\u00bfpppppppppppppppppppppppppppppppq\u0000~\u0000#ppppppq\u0000~"
+"\u0000Fpppppppppppppppppppppppppppppppppppppppppppppppppppppppppp"
+"pppppppppppq\u0000~\u0000\u0013q\u0000~\u0000Bpppppppppq\u0000~\u0000\u0010q\u0000~\u0000Apppppppppppppppppppp"
+"pppppppppppppppppppppppppq\u0000~\u0000\u000eppppppq\u0000~\u0000?ppppppppppppq\u0000~\u0000\u0005pq"
+"\u0000~\u0000\u0007pp"));
        }
                ...
                switch (state) {
                    ...
                    case  0 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.z.jaxb.gen.impl.TypeImpl)net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((net.sourceforge.czt.z.jaxb.gen.impl.TypeImpl)net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.z.jaxb.gen.impl.TypeImpl)net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        attIdx = context.getAttribute("", "Id");
                        if (attIdx >= 0) {
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.z.jaxb.gen.impl.TypeImpl)net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.z.jaxb.gen.impl.TypeImpl)net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        attIdx = context.getAttribute("", "Id");
                        if (attIdx >= 0) {
                ...
                try {
                    switch (state) {
                        case  4 :
                            ...
                            return ;
                        case  0 :
                            spawnHandlerFromText((((net.sourceforge.czt.z.jaxb.gen.impl.TypeImpl)net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                        case  2 :
                            attIdx = context.getAttribute("", "Id");
                            if (attIdx >= 0) {
