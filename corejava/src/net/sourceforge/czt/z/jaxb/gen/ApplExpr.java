 ...
 * The first (left) Expr is the function and the second (right)
 * is the argument.
 * The mixfix attribute distinguishes
 * m + n (mixfix=true) from (_ + _)(m, n) (mixfix=false).
 * 
 * Java content class for ApplExpr complex type.
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/research/projects/gnast/src/xsd/Z.xsd line 1462)
 * <p>
 * <pre>
