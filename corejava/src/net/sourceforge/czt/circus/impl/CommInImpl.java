...
import net.sourceforge.czt.circus.visitor.CommInVisitor;
...
public class CommInImpl
  extends CommParamImpl   implements CommIn
{
  /**
   ...
   */
  protected CommInImpl()
  {
  }

  /**
   * Compares the specified object with this CommInImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) CommInImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        CommInImpl object = (CommInImpl) obj;
        if (refName_ != null) {
  ...
  /**
   * Returns the hash code value for this CommInImpl.
   */
  public int hashCode()
  {
  ...
  {
    if (v instanceof CommInVisitor) {
      CommInVisitor visitor = (CommInVisitor) v;
      return visitor.visitCommIn(this);
    }
