...
public class AssignmentCommandImpl
  extends CommandImpl   implements AssignmentCommand
{
  /**
  ...
  {
    if (v instanceof AssignmentCommandVisitor) {
      AssignmentCommandVisitor visitor = (AssignmentCommandVisitor) v;
  ...
  {
    AssignmentCommand zedObject = null;
    try {
      java.util.List assignmentPair = (java.util.List) args[0];
      zedObject = new AssignmentCommandImpl();
