...
import net.sourceforge.czt.circus.visitor.ActualParamActionVisitor;

/**
 * An implementation of the interface
 * {@link ActualParamAction}.
 *
  ...
  extends CSPAction1Impl   implements ActualParamAction
{
   ...
   */
  protected ActualParamActionImpl()
  {
  }

  /**
   * Compares the specified object with this ActualParamActionImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) ActualParamActionImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ActualParamActionImpl object = (ActualParamActionImpl) obj;
        if (expr_ != null) {
  ...
  /**
   * Returns the hash code value for this ActualParamActionImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "ActualParamActionImpl".hashCode();
    if (expr_ != null) {
  ...
  {
    if (v instanceof ActualParamActionVisitor) {
      ActualParamActionVisitor visitor = (ActualParamActionVisitor) v;
      return visitor.visitActualParamAction(this);
    }
