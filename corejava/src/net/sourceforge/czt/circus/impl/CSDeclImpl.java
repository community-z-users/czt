...
import net.sourceforge.czt.circus.visitor.CSDeclVisitor;
...
public class CSDeclImpl
  extends CircusParaImpl   implements CSDecl
{
  /**
  ...
  /**
   * Compares the specified object with this CSDeclImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) CSDeclImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        CSDeclImpl object = (CSDeclImpl) obj;
        if (declName_ != null) {
  ...
  /**
   * Returns the hash code value for this CSDeclImpl.
   */
  public int hashCode()
  {
  ...
  {
    if (v instanceof CSDeclVisitor) {
      CSDeclVisitor visitor = (CSDeclVisitor) v;
      return visitor.visitCSDecl(this);
    }
  ...
  {
    Object[] erg = { getDeclName(), getCSExpr() };
    return erg;
  }
