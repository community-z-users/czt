...
import net.sourceforge.czt.circus.visitor.DescProcessVisitor;
...
public class DescProcessImpl
  extends ProcessDefImpl   implements DescProcess
{
  /**
   ...
   */
  protected DescProcessImpl()
  {
  }

  /**
   * Compares the specified object with this DescProcessImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) DescProcessImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        DescProcessImpl object = (DescProcessImpl) obj;
  ...
  /**
   * Returns the hash code value for this DescProcessImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "DescProcessImpl".hashCode();
    if (stateSchemaRefName_ != null) {
  ...
  {
    if (v instanceof DescProcessVisitor) {
      DescProcessVisitor visitor = (DescProcessVisitor) v;
      return visitor.visitDescProcess(this);
    }
  ...
  {
    DescProcess zedObject = null;
    try {
      net.sourceforge.czt.z.ast.RefName stateSchemaRefName = (net.sourceforge.czt.z.ast.RefName) args[0];
      java.util.List para = (java.util.List) args[1];
      Action mainAction = (Action) args[2];
      zedObject = new DescProcessImpl();
  ...
  {
    Object[] erg = { getStateSchemaRefName(), getPara(), getMainAction() };
    return erg;
  }
