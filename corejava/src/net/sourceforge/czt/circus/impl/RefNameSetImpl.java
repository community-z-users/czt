...
public class RefNameSetImpl
  extends NameSetImpl   implements RefNameSet
{
  /**
   ...
   */
  protected RefNameSetImpl()
  {
  }

  /**
   * Compares the specified object with this RefNameSetImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) RefNameSetImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        RefNameSetImpl object = (RefNameSetImpl) obj;
        if (refName_ != null) {
  ...
  /**
   * Returns the hash code value for this RefNameSetImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "RefNameSetImpl".hashCode();
    if (refName_ != null) {
  ...
  {
    if (v instanceof RefNameSetVisitor) {
      RefNameSetVisitor visitor = (RefNameSetVisitor) v;
      return visitor.visitRefNameSet(this);
    }
