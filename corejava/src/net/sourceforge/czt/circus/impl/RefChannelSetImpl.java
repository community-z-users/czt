...
public class RefChannelSetImpl
  extends ChannelSetImpl   implements RefChannelSet
{
  /**
   ...
   */
  protected RefChannelSetImpl()
  {
  }

  /**
   * Compares the specified object with this RefChannelSetImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) RefChannelSetImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        RefChannelSetImpl object = (RefChannelSetImpl) obj;
        if (refName_ != null) {
  ...
  /**
   * Returns the hash code value for this RefChannelSetImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "RefChannelSetImpl".hashCode();
    if (refName_ != null) {
  ...
  {
    if (v instanceof RefChannelSetVisitor) {
      RefChannelSetVisitor visitor = (RefChannelSetVisitor) v;
      return visitor.visitRefChannelSet(this);
    }
