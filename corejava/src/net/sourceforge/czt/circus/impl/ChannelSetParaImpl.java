  ...
  extends ParaImpl   implements ChannelSetPara
{
  ...
  public Object accept(net.sourceforge.czt.util.Visitor v)
  {
    if (v instanceof ChannelSetParaVisitor) {
      ChannelSetParaVisitor visitor = (ChannelSetParaVisitor) v;
  ...
  public net.sourceforge.czt.base.ast.Term create(Object[] args)
  {
    ...
    try {
      ...
      zedObject = new ChannelSetParaImpl();
  ...
  {
    Object[] erg = { getDeclName(), getChannelSet() };
    return erg;
  }
