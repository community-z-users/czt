...
import net.sourceforge.czt.circus.visitor.SchChannelParaVisitor;
...
public class SchChannelParaImpl
  extends ParaImpl   implements SchChannelPara
{
  /**
   ...
   */
  protected SchChannelParaImpl()
  {
  }

  /**
   * Compares the specified object with this SchChannelParaImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) SchChannelParaImpl and all the getter methods except getAnns
  ...
  /**
   * Returns the hash code value for this SchChannelParaImpl.
   */
  public int hashCode()
  {
  ...
  {
    if (v instanceof SchChannelParaVisitor) {
      SchChannelParaVisitor visitor = (SchChannelParaVisitor) v;
      return visitor.visitSchChannelPara(this);
    }
