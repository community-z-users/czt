  ...
  extends TermImpl   implements ProcessSignature
{
  ...
  public Object accept(net.sourceforge.czt.util.Visitor v)
  {
    if (v instanceof ProcessSignatureVisitor) {
      ProcessSignatureVisitor visitor = (ProcessSignatureVisitor) v;
  ...
  {
    ProcessSignature zedObject = null;
    try {
      ...
      zedObject = new ProcessSignatureImpl();
  ...
  {
    Object[] erg = { getProcessName(), getFormalParams() };
    return erg;
  }
  ...
  private net.sourceforge.czt.z.ast.VarDecl formalParams_;

  public net.sourceforge.czt.z.ast.VarDecl getFormalParams()
  {
    return formalParams_;
  }

  public void setFormalParams(net.sourceforge.czt.z.ast.VarDecl formalParams)
  {
