...
import net.sourceforge.czt.circus.visitor.ParamProcessDescVisitor;

/**
 * An implementation of the interface
 * {@link ParamProcessDesc}.
 *
 * @author Gnast version 0.1
 */
public class ParamProcessDescImpl
  extends ProcessDescImpl   implements ParamProcessDesc
{
  /**
   ...
   */
  protected ParamProcessDescImpl()
  {
  }

  /**
   * Compares the specified object with this ParamProcessDescImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) ParamProcessDescImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ParamProcessDescImpl object = (ParamProcessDescImpl) obj;
        if (varDecl_ != null) {
  ...
  /**
   * Returns the hash code value for this ParamProcessDescImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "ParamProcessDescImpl".hashCode();
    if (varDecl_ != null) {
  ...
  {
    if (v instanceof ParamProcessDescVisitor) {
      ParamProcessDescVisitor visitor = (ParamProcessDescVisitor) v;
      return visitor.visitParamProcessDesc(this);
    }
