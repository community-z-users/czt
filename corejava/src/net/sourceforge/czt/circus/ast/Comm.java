 ...
 */
public interface Comm extends TermA
{
  ...
  /**
   * <p>Returns the CommParam elements.</p>
   * <p>To add or remove elements, use the methods provided by
   * the List interface (that's why there is no need for a setter
   * method).</p>
   *
   * @return a list of CommParam elements.
   */
  net.sourceforge.czt.base.ast.ListTerm getCommParam();
