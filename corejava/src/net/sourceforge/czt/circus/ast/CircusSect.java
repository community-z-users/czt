 ...
 */
public interface CircusSect extends Sect
{
  ...
  /**
   * <p>Returns the CircusPara elements.</p>
   * <p>To add or remove elements, use the methods provided by
   * the List interface (that's why there is no need for a setter
   * method).</p>
   *
   * @return a list of CircusPara elements.
   */
  net.sourceforge.czt.base.ast.ListTerm getCircusPara();
}
