 ...
 */
public interface AssignmentPair extends Term
{
   ...
   */
  net.sourceforge.czt.z.ast.RefName getLHS();
   ...
   * @see #getLHS
   */
  void setLHS(net.sourceforge.czt.z.ast.RefName lHS);
   ...
   */
  net.sourceforge.czt.z.ast.Expr getRHS();
   ...
   * @see #getRHS
   */
  void setRHS(net.sourceforge.czt.z.ast.Expr rHS);
}
