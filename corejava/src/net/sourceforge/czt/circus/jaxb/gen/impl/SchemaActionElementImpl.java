    ...
    implements net.sourceforge.czt.circus.jaxb.gen.SchemaActionElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.circus.jaxb.gen.SchemaActionElement.class);
    }
    ...
    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionElementImpl.Unmarshaller(context);
    }

    public void serializeBody(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://czt.sourceforge.net/circus", "SchemaAction");
...
+"\u001fsq\u0000~\u0000 t\u0000\fSchemaActiont\u0000!http://czt.sourceforge.net/circussr"
...
+"l;xp\u0000\u0000\u0000\u000f\u0001pq\u0000~\u0000\u0010q\u0000~\u0000Kq\u0000~\u0000Hq\u0000~\u0000\fq\u0000~\u0000@q\u0000~\u0000\u0012q\u0000~\u0000Bq\u0000~\u0000Jq\u0000~\u0000%q\u0000~\u0000O"
+"q\u0000~\u0000Sq\u0000~\u0000\nq\u0000~\u0000\tq\u0000~\u0000\u0015q\u0000~\u0000Cx"));
        }
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionElementImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("SchemaAction" == ___local)&&("http://czt.sourceforge.net/circus" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.SchemaActionElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
