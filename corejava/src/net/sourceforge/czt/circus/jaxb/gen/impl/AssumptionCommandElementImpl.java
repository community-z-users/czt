    ...
    implements net.sourceforge.czt.circus.jaxb.gen.AssumptionCommandElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.circus.jaxb.gen.AssumptionCommandElement.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "AssumptionCommand";
    }

    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandElementImpl.Unmarshaller(context);
    }

    public void serializeBody(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://czt.sourceforge.net/circus", "AssumptionCommand");
...
+" t\u0000\u0011AssumptionCommandt\u0000!http://czt.sourceforge.net/circussr\u0000"
...
+";xp\u0000\u0000\u0000.\u0001pq\u0000~\u0000Cq\u0000~\u0000\u0010q\u0000~\u0000\u0015q\u0000~\u0000Nq\u0000~\u0000Tq\u0000~\u0000Zq\u0000~\u0000`q\u0000~\u0000fq\u0000~\u0000lq\u0000~\u0000rq"
+"\u0000~\u0000xq\u0000~\u0000~q\u0000~\u0000Dq\u0000~\u0000\u0084q\u0000~\u0000\u008aq\u0000~\u0000\u0090q\u0000~\u0000Iq\u0000~\u0000\u0096q\u0000~\u0000\u0012q\u0000~\u0000Mq\u0000~\u0000Sq\u0000~\u0000Yq"
+"\u0000~\u0000_q\u0000~\u0000eq\u0000~\u0000kq\u0000~\u0000qq\u0000~\u0000wq\u0000~\u0000}q\u0000~\u0000\u0083q\u0000~\u0000\u0089q\u0000~\u0000Fq\u0000~\u0000Gq\u0000~\u0000\u008fq\u0000~\u0000\u0095q"
+"\u0000~\u0000\nq\u0000~\u0000Hq\u0000~\u0000Eq\u0000~\u0000Jq\u0000~\u0000\fq\u0000~\u0000Aq\u0000~\u0000%q\u0000~\u0000\u009aq\u0000~\u0000Kq\u0000~\u0000Bq\u0000~\u0000@q\u0000~\u0000\tx"));
        }
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandElementImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("AssumptionCommand" == ___local)&&("http://czt.sourceforge.net/circus" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssumptionCommandElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
