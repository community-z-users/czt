            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        if (("AssignmentPair" == ___local)&&("http://czt.sourceforge.net/circus" == ___uri)) {
                            _getAssignmentPair().add(((net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentPairElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentPairElementImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                    ...
                    case  0 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.CommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentCommandImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.CommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentCommandImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
                        if (("LHS" == ___local)&&("http://czt.sourceforge.net/circus" == ___uri)) {
                            _getAssignmentPair().add(((net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentPairImpl) spawnChildFromEnterElement((net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentPairImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.circus.jaxb.gen.impl.CommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentCommandImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.CommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentCommandImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.CommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentCommandImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  2 :
                            ...
                            return ;
                        case  0 :
                            spawnHandlerFromText((((net.sourceforge.czt.circus.jaxb.gen.impl.CommandImpl)net.sourceforge.czt.circus.jaxb.gen.impl.AssignmentCommandImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                    }
