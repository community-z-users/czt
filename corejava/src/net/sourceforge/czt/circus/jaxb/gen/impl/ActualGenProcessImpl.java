    ...
    implements net.sourceforge.czt.circus.jaxb.gen.ActualGenProcess, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.circus.jaxb.gen.ActualGenProcess.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "ActualGenProcess";
    }

    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.circus.jaxb.gen.impl.ActualGenProcessImpl.Unmarshaller(context);
    }

    public void serializeBody(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://czt.sourceforge.net/circus", "ActualGenProcess");
...
+"~\u0000\u0010pq\u0000~\u0000+q\u0000~\u0000;q\u0000~\u0000 sq\u0000~\u0000!t\u0000\u0010ActualGenProcesst\u0000!http://czt.so"
+"urceforge.net/circussr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000"
...
+"/grammar/ExpressionPool;xp\u0000\u0000\u0000\u00c5\u0001pq\u0000~\u0000\u00e7q\u0000~\u0000\u00ebq\u0000~\u0000\u00e4q\u0000~\u0000Gq\u0000~\u0000\u00f4q\u0000~"
...
+"\u0000Tq\u0000~\u0000\u00ddq\u0000~\u0000Bq\u0000~\u0000\u00efq\u0000~\u0000\u00eaq\u0000~\u0000\u00fbq\u0000~\u0000Nq\u0000~\u0000\u00e1q\u0000~\u0000Fq\u0000~\u0000\u00f3q\u0000~\u0000&q\u0000~\u0001\u00f9x"));
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.circus.jaxb.gen.impl.ActualGenProcessImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.ProcessEImpl)net.sourceforge.czt.circus.jaxb.gen.impl.ActualGenProcessImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.circus.jaxb.gen.impl.ProcessEImpl)net.sourceforge.czt.circus.jaxb.gen.impl.ActualGenProcessImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("ActualGenProcess" == ___local)&&("http://czt.sourceforge.net/circus" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.ProcessEImpl)net.sourceforge.czt.circus.jaxb.gen.impl.ActualGenProcessImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.ProcessEImpl)net.sourceforge.czt.circus.jaxb.gen.impl.ActualGenProcessImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((net.sourceforge.czt.circus.jaxb.gen.impl.ProcessEImpl)net.sourceforge.czt.circus.jaxb.gen.impl.ActualGenProcessImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
