 ...
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/research/czt/gnast/src/xsd/Circus.xsd line 1222)
 * <p>
 * <pre>
 ...
 *         &lt;element name="DeclActions" type="{http://czt.sourceforge.net/circus}ActionPara" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="DeclNameSets" type="{http://czt.sourceforge.net/circus}NameSetPara" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends net.sourceforge.czt.circus.jaxb.gen.ProcessDef
{
     ...
     * {@link net.sourceforge.czt.circus.jaxb.gen.NameSetPara}
     * 
     */
    java.util.List getDeclNameSets();

    /**
     * Gets the value of the DeclActions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the DeclActions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDeclActions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link net.sourceforge.czt.circus.jaxb.gen.ActionPara}
     * 
     */
    java.util.List getDeclActions();

    /**
     * Gets the value of the DeclZParagraphs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the DeclZParagraphs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDeclZParagraphs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    java.util.List getDeclZParagraphs();
     ...
     *     {@link net.sourceforge.czt.circus.jaxb.gen.AssumptionCommandElement}
