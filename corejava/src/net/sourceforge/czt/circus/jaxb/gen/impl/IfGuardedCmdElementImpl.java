    ...
    implements net.sourceforge.czt.circus.jaxb.gen.IfGuardedCmdElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.circus.jaxb.gen.IfGuardedCmdElement.class);
    }
    ...
    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdElementImpl.Unmarshaller(context);
    }

    public void serializeBody(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://czt.sourceforge.net/circus", "IfGuardedCmd");
...
+"ceforge.czt.circus.jaxb.gen.GuardedActionq\u0000~\u0000$sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0016"
+"q\u0000~\u0000\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000eGuardedActionst\u0000!http://czt.so"
+"urceforge.net/circussq\u0000~\u0000\u000bppsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000"
+" t\u0000\fIfGuardedCmdq\u0000~\u0000Msr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000"
...
+"v/grammar/ExpressionPool;xp\u0000\u0000\u0000\r\u0001pq\u0000~\u0000\u0010q\u0000~\u0000Bq\u0000~\u0000\fq\u0000~\u0000\u0012q\u0000~\u0000Dq\u0000"
+"~\u0000%q\u0000~\u0000Iq\u0000~\u0000Nq\u0000~\u0000\nq\u0000~\u0000@q\u0000~\u0000\tq\u0000~\u0000\u0015q\u0000~\u0000Ex"));
        }
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdElementImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdImpl)net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdImpl)net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdImpl)net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdImpl)net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdImpl)net.sourceforge.czt.circus.jaxb.gen.impl.IfGuardedCmdElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
