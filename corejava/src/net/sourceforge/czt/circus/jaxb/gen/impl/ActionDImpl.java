    ...
    implements net.sourceforge.czt.circus.jaxb.gen.ActionD, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    {
        int idx1 = 0;
        final int len1 = ((_VarDecl == null)? 0 :_VarDecl.size());
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        if (("VarDecl" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getVarDecl().add(((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclElementImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                    ...
                    case  3 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getVarDecl().add(((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        return ;
                    case  3 :
                        _getVarDecl().add(((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl) spawnChildFromLeaveElement((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl.class), 4, ___uri, ___local, ___qname)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        return ;
                    case  3 :
                        _getVarDecl().add(((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl.class), 4, ___uri, ___local, ___qname)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        return ;
                    case  3 :
                        _getVarDecl().add(((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl) spawnChildFromLeaveAttribute((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl.class), 4, ___uri, ___local, ___qname)));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  0 :
                            ...
                            return ;
                        case  3 :
                            _getVarDecl().add(((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl) spawnChildFromText((net.sourceforge.czt.z.jaxb.gen.impl.VarDeclImpl.class), 4, value)));
                            return ;
                    }
