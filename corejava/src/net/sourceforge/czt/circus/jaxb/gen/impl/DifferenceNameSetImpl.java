    ...
    implements net.sourceforge.czt.circus.jaxb.gen.DifferenceNameSet, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.circus.jaxb.gen.DifferenceNameSet.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "DifferenceNameSet";
    }

    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.circus.jaxb.gen.impl.DifferenceNameSetImpl.Unmarshaller(context);
    }

    public void serializeBody(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://czt.sourceforge.net/circus", "DifferenceNameSet");
...
+"q\u0000~\u0000\u0010pq\u0000~\u0000+q\u0000~\u0000;q\u0000~\u0000 sq\u0000~\u0000!t\u0000\u0011DifferenceNameSett\u0000!http://czt"
+".sourceforge.net/circussr\u0000\"com.sun.msv.grammar.ExpressionPoo"
...
+"msv/grammar/ExpressionPool;xp\u0000\u0000\u0000%\u0001pq\u0000~\u0000wq\u0000~\u0000dq\u0000~\u0000|q\u0000~\u0000Dq\u0000~\u0000f"
+"q\u0000~\u0000\tq\u0000~\u0000&q\u0000~\u0000\u0080q\u0000~\u0000Aq\u0000~\u0000cq\u0000~\u0000\rq\u0000~\u0000Cq\u0000~\u0000eq\u0000~\u0000\nq\u0000~\u0000\u0011q\u0000~\u0000\u000bq\u0000~\u0000\u0016"
+"q\u0000~\u0000Gq\u0000~\u0000Mq\u0000~\u0000Sq\u0000~\u0000Yq\u0000~\u0000_q\u0000~\u0000iq\u0000~\u0000nq\u0000~\u0000sq\u0000~\u0000xq\u0000~\u0000}q\u0000~\u0000\u0013q\u0000~\u0000F"
+"q\u0000~\u0000Lq\u0000~\u0000Rq\u0000~\u0000Xq\u0000~\u0000Bq\u0000~\u0000^q\u0000~\u0000hq\u0000~\u0000mq\u0000~\u0000rx"));
        }
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.circus.jaxb.gen.impl.DifferenceNameSetImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.NameSet2Impl)net.sourceforge.czt.circus.jaxb.gen.impl.DifferenceNameSetImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.circus.jaxb.gen.impl.NameSet2Impl)net.sourceforge.czt.circus.jaxb.gen.impl.DifferenceNameSetImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.NameSet2Impl)net.sourceforge.czt.circus.jaxb.gen.impl.DifferenceNameSetImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.NameSet2Impl)net.sourceforge.czt.circus.jaxb.gen.impl.DifferenceNameSetImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((net.sourceforge.czt.circus.jaxb.gen.impl.NameSet2Impl)net.sourceforge.czt.circus.jaxb.gen.impl.DifferenceNameSetImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
