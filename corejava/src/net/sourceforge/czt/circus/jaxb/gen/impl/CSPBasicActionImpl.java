...
public class CSPBasicActionImpl
    extends net.sourceforge.czt.circus.jaxb.gen.impl.CSPActionImpl
    implements net.sourceforge.czt.circus.jaxb.gen.CSPBasicAction, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.circus.jaxb.gen.CSPBasicAction.class);
    }

    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.Unmarshaller(context);
    }
...
+";xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u000fq\u0000~\u0000\u0012q\u0000~\u0000\"q\u0000~\u0000\u0005q\u0000~\u0000\rx"));
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.CSPActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((net.sourceforge.czt.circus.jaxb.gen.impl.CSPActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.circus.jaxb.gen.impl.CSPActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  1 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.CSPActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  1 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.circus.jaxb.gen.impl.CSPActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  1 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  0 :
                            spawnHandlerFromText((((net.sourceforge.czt.circus.jaxb.gen.impl.CSPActionImpl)net.sourceforge.czt.circus.jaxb.gen.impl.CSPBasicActionImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                        case  1 :
