...
/**
 * Java content class for Comm complex type.
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/research/czt/gnast/src/xsd/Circus.xsd line 1402)
 * <p>
 * <pre>
 * &lt;complexType name="Comm">
 *   &lt;complexContent>
 *     &lt;extension base="{http://czt.sourceforge.net/zml}TermA">
 *       &lt;sequence>
 *         &lt;element ref="{http://czt.sourceforge.net/zml}RefName"/>
 *         &lt;element ref="{http://czt.sourceforge.net/circus}CommParam" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    extends net.sourceforge.czt.z.jaxb.gen.TermA
{
    ...
    /**
     * Gets the value of the CommParam property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the CommParam property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCommParam().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link net.sourceforge.czt.circus.jaxb.gen.CommParamElement}
     * {@link net.sourceforge.czt.circus.jaxb.gen.CommOutElement}
     * {@link net.sourceforge.czt.circus.jaxb.gen.CommInElement}
     * {@link net.sourceforge.czt.circus.jaxb.gen.CommParam}
     * {@link net.sourceforge.czt.circus.jaxb.gen.CommMixedElement}
     * 
     */
    java.util.List getCommParam();
