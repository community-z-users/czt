 ...
 */
public interface PredSequent extends Sequent
{
  ...
  /**
   * Returns the Deduction element.
   *
   * @return the Deduction element.
   */
  Deduction getDeduction();

  /**
   * Sets the Deduction element.
   *
   * @param deduction   the Deduction element.
   * @see #getDeduction
   */
