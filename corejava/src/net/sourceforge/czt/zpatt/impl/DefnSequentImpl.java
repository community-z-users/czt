...
import net.sourceforge.czt.zpatt.visitor.DefnSequentVisitor;
  ...
  extends PrimitiveSequentImpl   implements DefnSequent
{
   ...
   */
  protected DefnSequentImpl()
  {
  }

  /**
   * Compares the specified object with this DefnSequentImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) DefnSequentImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        DefnSequentImpl object = (DefnSequentImpl) obj;
        if (declName_ != null) {
  ...
  /**
   * Returns the hash code value for this DefnSequentImpl.
   */
  public int hashCode()
  {
    ...
    hashCode += "DefnSequentImpl".hashCode();
    if (declName_ != null) {
  ...
  {
    if (v instanceof DefnSequentVisitor) {
      DefnSequentVisitor visitor = (DefnSequentVisitor) v;
      return visitor.visitDefnSequent(this);
    }
  ...
  {
    Object[] erg = { getSequentContext(), getDeclName(), getExpr() };
    return erg;
  }
