...
public class JokerDeclListImpl
  extends DeclImpl   implements JokerDeclList
{
  /**
  ...
  public Object accept(net.sourceforge.czt.util.Visitor v)
  {
    if (v instanceof JokerDeclListVisitor) {
      JokerDeclListVisitor visitor = (JokerDeclListVisitor) v;
  ...
  {
    JokerDeclList zedObject = null;
    try {
      String name = (String) args[0];
      zedObject = new JokerDeclListImpl();
