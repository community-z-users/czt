...
public class ClassUnionExprImpl
  extends Expr2Impl   implements ClassUnionExpr
{
  /**
  ...
  {
    if (v instanceof ClassUnionExprVisitor) {
      ClassUnionExprVisitor visitor = (ClassUnionExprVisitor) v;
  ...
  {
    ClassUnionExpr zedObject = null;
    try {
      Expr leftExpr = (Expr) args[0];
      Expr rightExpr = (Expr) args[1];
      zedObject = new ClassUnionExprImpl();
