...
import net.sourceforge.czt.oz.visitor.ConjOpExprVisitor;
...
extends OperationExprImpl implements ConjOpExpr
{
  private static final Logger sLogger =
    Logger.getLogger("net.sourceforge.czt.oz.impl.ConjOpExprImpl");
   ...
   */
  protected ConjOpExprImpl() { }

  /**
   * Compares the specified object with this ConjOpExprImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) ConjOpExprImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if(obj != null &&
       ...
       super.equals(obj)) {
      ConjOpExprImpl object = (ConjOpExprImpl) obj;
  ...
  public int hashCode()
  {
    ...
    hashCode += "ConjOpExprImpl".hashCode();
    if(mLeftOpExpr != null) {
  ...
  {
    if (v instanceof ConjOpExprVisitor)
    {
      ConjOpExprVisitor visitor = (ConjOpExprVisitor) v;
      return visitor.visitConjOpExpr(this);
    }
  ...
  public net.sourceforge.czt.zed.ast.Term create(Object[] args) {
    sLogger.entering("ConjOpExprImpl", "create", args);
    ConjOpExpr zedObject = null;
    try {
      OperationExpr leftOpExpr = (OperationExpr) args[0];
      OperationExpr rightOpExpr = (OperationExpr) args[1];
      zedObject = new ConjOpExprImpl();
    ...
    sLogger.exiting("ConjOpExprImpl", "create", zedObject);
    return zedObject;
  }

  public Object[] getChildren()
  {
    sLogger.entering("ConjOpExprImpl", "getChildren");
    Object[] erg = { getLeftOpExpr(), getRightOpExpr() };
    sLogger.exiting("ConjOpExprImpl", "getChildren", erg);
    return erg;
  }
