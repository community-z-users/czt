  ...
  extends ClassTypeImpl   implements ClassRefType
{
  ...
  {
    Object[] erg = { getClassSig(), getThisClass(), getSuperClass(), getVisibilityList() };
    return erg;
  }
  ...
  private net.sourceforge.czt.base.ast.ListTerm superClass_ =
    new net.sourceforge.czt.base.impl.ListTermImpl(ClassRef.class);

  public net.sourceforge.czt.base.ast.ListTerm getSuperClass()
  {
    return superClass_;
  }
