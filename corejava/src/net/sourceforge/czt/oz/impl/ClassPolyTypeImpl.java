...
public class ClassPolyTypeImpl
  extends ClassTypeImpl   implements ClassPolyType
{
  /**
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (rootClass_ != null) {
          if (!rootClass_.equals(object.rootClass_)) {
            return false;
          }
        }
        else {
          if (object.rootClass_ != null) {
            return false;
          }
        }
        return true;
  ...
  public int hashCode()
  {
    ...
    if (rootClass_ != null) {
      hashCode += constant * rootClass_.hashCode();
    }
    return hashCode;
  }
  ...
  {
    ClassPolyType zedObject = null;
    try {
      ClassSig classSig = (ClassSig) args[0];
      ClassRef rootClass = (ClassRef) args[1];
      zedObject = new ClassPolyTypeImpl();
  ...
  {
    Object[] erg = { getClassSig(), getRootClass() };
    return erg;
  }

  private ClassRef rootClass_;
  ...
  public void setRootClass(ClassRef rootClass)
  {
