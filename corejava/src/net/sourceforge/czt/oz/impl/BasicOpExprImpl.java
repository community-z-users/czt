...
import net.sourceforge.czt.oz.visitor.BasicOpExprVisitor;
...
extends OperationExprImpl implements BasicOpExpr
{
   ...
   * also a(n) BasicOpExprImpl and all the getter methods except getAnns
  ...
  /**
   * Returns the hash code value for this BasicOpExprImpl.
   * The hash code of a BasicOpExprImpl is defined to be
  ...
  public net.sourceforge.czt.zed.ast.Term create(Object[] args) {
    ...
    try {
      ...
      net.sourceforge.czt.core.ast.SchText schText = (net.sourceforge.czt.core.ast.SchText) args[1];
