 ...
 */
public interface ClassSignature extends Term
{

  /**
   * Returns the ClassName element.
   *
   * @return the ClassName element.
   */
  net.sourceforge.czt.z.ast.DeclName getClassName();

  /**
   * Sets the ClassName element.
   *
   * @param className   the ClassName element.
   * @see #getClassName
   */
   ...
   */
  net.sourceforge.czt.base.ast.ListTerm getParentClass();
