...
public interface OzVisitor
  extends
    ...
    net.sourceforge.czt.oz.visitor.PromotedAttrExprVisitor,
    ...
    net.sourceforge.czt.oz.visitor.SelfExprVisitor,
    ...
    net.sourceforge.czt.oz.visitor.PromotedInitPredVisitor,
