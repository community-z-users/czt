...
+"ExpressionPool;xp\u0000\u0000\u0000B\u0001pq\u0000~\u0000\u0006q\u0000~\u0000\u009eq\u0000~\u0000\u008aq\u0000~\u0000\u00b3q\u0000~\u0000\tq\u0000~\u0000\u00b2q\u0000~\u0000\fq\u0000"
+"~\u0000\u0007q\u0000~\u0000{q\u0000~\u0000mq\u0000~\u0000_q\u0000~\u0000Rq\u0000~\u0000\u00a8q\u0000~\u0000\u00a0q\u0000~\u0000\u0094q\u0000~\u0000\u008cq\u0000~\u0000\u0080q\u0000~\u0000rq\u0000~\u0000dq\u0000"
+"~\u0000Wq\u0000~\u0000Hq\u0000~\u0000\u0017q\u0000~\u0000\u00b5q\u0000~\u0000\u00bdq\u0000~\u0000\u00adq\u0000~\u0000\u0099q\u0000~\u0000\u0085q\u0000~\u0000wq\u0000~\u0000iq\u0000~\u0000[q\u0000~\u0000Mq\u0000"
+"~\u0000*q\u0000~\u0000\u00c2q\u0000~\u0000\nq\u0000~\u0000\u000eq\u0000~\u0000\bq\u0000~\u0000\u00b1q\u0000~\u0000\u009dq\u0000~\u0000\u0089q\u0000~\u0000\u00b6q\u0000~\u0000\u00a9q\u0000~\u0000\u00a1q\u0000~\u0000\u0095q\u0000"
+"~\u0000\u008dq\u0000~\u0000\u0081q\u0000~\u0000sq\u0000~\u0000eq\u0000~\u0000Xq\u0000~\u0000Iq\u0000~\u0000\u001aq\u0000~\u0000\u000bq\u0000~\u0000\u00beq\u0000~\u0000\u0005q\u0000~\u0000\u00a6q\u0000~\u0000\u0092q\u0000"
+"~\u0000~q\u0000~\u0000pq\u0000~\u0000bq\u0000~\u0000Uq\u0000~\u0000Fq\u0000~\u0000\u0015q\u0000~\u0000\u00bbq\u0000~\u0000|q\u0000~\u0000nq\u0000~\u0000`q\u0000~\u0000Sx"));
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  24 :
                        ...
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getOperation().add(((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl) spawnChildFromEnterElement((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl.class), 25, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Name" == ___local)&&("http://czt.sourceforge.net/object-z" == ___uri)) {
                            _getOperation().add(((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl) spawnChildFromEnterElement((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl.class), 25, ___uri, ___local, ___qname, __atts)));
            ...
            while (true) {
                switch (state) {
                    ...
                    case  24 :
                        ...
                        _getOperation().add(((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl) spawnChildFromLeaveElement((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl.class), 25, ___uri, ___local, ___qname)));
                        return ;
                    case  12 :
                        if (("InheritedClass" == ___local)&&("http://czt.sourceforge.net/object-z" == ___uri)) {
                            context.popAttributes();
                ...
                switch (state) {
                    ...
                    case  24 :
                        if (("Box" == ___local)&&("" == ___uri)) {
                            _getOperation().add(((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl.class), 25, ___uri, ___local, ___qname)));
                            return ;
                        }
                        _getOperation().add(((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl.class), 25, ___uri, ___local, ___qname)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  24 :
                        ...
                        _getOperation().add(((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl) spawnChildFromLeaveAttribute((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl.class), 25, ___uri, ___local, ___qname)));
                        return ;
                    case  7 :
                        state = 10;
                        continue outer;
                ...
                try {
                    switch (state) {
                        ...
                        case  24 :
                            ...
                            _getOperation().add(((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl) spawnChildFromText((net.sourceforge.czt.oz.jaxb.gen.impl.OperationImpl.class), 25, value)));
                            return ;
                        case  7 :
                            state = 10;
                            continue outer;
