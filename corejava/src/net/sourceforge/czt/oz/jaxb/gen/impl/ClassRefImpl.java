    ...
    implements net.sourceforge.czt.oz.jaxb.gen.ClassRef, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    protected com.sun.xml.bind.util.ListImpl _Type2;
    ...
    protected com.sun.xml.bind.util.ListImpl _getType2() {
        if (_Type2 == null) {
            _Type2 = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Type2;
    }

    public java.util.List getType2() {
        return _getType2();
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Type2 == null)? 0 :_Type2 .size());
        int idx2 = 0;
        ...
        while (idx1 != len1) {
            if (_Type2 .get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Type2 .get(idx1 ++)), "Type2");
            } else {
                context.startElement("http://czt.sourceforge.net/zml", "Type2");
                int idx_2 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Type2 .get(idx_2 ++)), "Type2");
                context.endNamespaceDecls();
                int idx_3 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Type2 .get(idx_3 ++)), "Type2");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Type2 .get(idx1 ++)), "Type2");
                context.endElement();
            }
        ...
        while (idx2 != len2) {
            if (_NameNamePair.get(idx2) instanceof javax.xml.bind.Element) {
                ...
                int idx_4 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _NameNamePair.get(idx_4 ++)), "NameNamePair");
                context.endNamespaceDecls();
                int idx_5 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _NameNamePair.get(idx_5 ++)), "NameNamePair");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _NameNamePair.get(idx2 ++)), "NameNamePair");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Type2 .get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Type2 .get(idx1 ++)), "Type2");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Type2 .get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Type2 .get(idx1 ++)), "Type2");
            } else {
                idx1 += 1;
            }
        }
...
+"urceforge.czt.oz.jaxb.gen.ClassPolyTypeElementq\u0000~\u0000$sq\u0000~\u0000\nq\u0000~"
+"\u0000\u000fp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u00004"
+"net.sourceforge.czt.tcoz.jaxb.gen.ChannelTypeElementq\u0000~\u0000$sq\u0000"
...
+"\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u00003net.sourceforge.czt.oz.jaxb.gen.ClassRef"
+"TypeElementq\u0000~\u0000$sq\u0000~\u0000\nq\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000f"
+"pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u00006net.sourceforge.czt.circus.jaxb.gen"
+".ProcessTypeElementq\u0000~\u0000$sq\u0000~\u0000\nq\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000"
+"~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u00005net.sourceforge.czt.circus."
+"jaxb.gen.ActionTypeElementq\u0000~\u0000$sq\u0000~\u0000\nq\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000"
+"~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000/net.sourceforge.czt."
+"z.jaxb.gen.PowerTypeElementq\u0000~\u0000$sq\u0000~\u0000\nq\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q"
+"\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000.net.sourceforge.czt"
+".z.jaxb.gen.ProdTypeElementq\u0000~\u0000$q\u0000~\u0000\u001fsq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000"
+"~\u0000\bq\u0000~\u0000\u000fpsq\u0000~\u0000\nq\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q"
+"\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u00002net.sourceforge.czt.z.jaxb.gen.NameNamePai"
+"rElementq\u0000~\u0000$sq\u0000~\u0000\nq\u0000~\u0000\u000fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\npp\u0000sq\u0000~\u0000\bppsq\u0000~\u0000\u0013q\u0000~"
+"\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000+net.sourceforge.czt.z"
+".jaxb.gen.NameNamePairq\u0000~\u0000$sq\u0000~\u0000\bppsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~"
+"\u0000\u001fsq\u0000~\u0000 t\u0000\fNameNamePairq\u0000~\u0000?q\u0000~\u0000\u001fsr\u0000\"com.sun.msv.grammar.Exp"
...
+"$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000:\u0001pq\u0000~\u0000\u0007q\u0000~\u0000]q\u0000~\u0000W"
+"q\u0000~\u0000\u00abq\u0000~\u0000Hq\u0000~\u0000\u0010q\u0000~\u0000^q\u0000~\u0000\u00a2q\u0000~\u0000\u0005q\u0000~\u0000\tq\u0000~\u0000Tq\u0000~\u0000\u00aeq\u0000~\u0000\u00a6q\u0000~\u0000\u009dq\u0000~\u0000\u0097"
+"q\u0000~\u0000\u0091q\u0000~\u0000\u008bq\u0000~\u0000\u0085q\u0000~\u0000\u007fq\u0000~\u0000yq\u0000~\u0000sq\u0000~\u0000mq\u0000~\u0000gq\u0000~\u0000\u00adq\u0000~\u0000\u00a5q\u0000~\u0000\u009cq\u0000~\u0000\u0096"
+"q\u0000~\u0000\u0090q\u0000~\u0000\u008aq\u0000~\u0000\u0084q\u0000~\u0000~q\u0000~\u0000xq\u0000~\u0000rq\u0000~\u0000lq\u0000~\u0000fq\u0000~\u0000`q\u0000~\u0000[q\u0000~\u0000Jq\u0000~\u0000B"
+"q\u0000~\u0000\u00b2q\u0000~\u0000Oq\u0000~\u0000%q\u0000~\u0000\u0012q\u0000~\u0000aq\u0000~\u0000Kq\u0000~\u0000Cq\u0000~\u0000\u0015q\u0000~\u0000Xq\u0000~\u0000\u0006q\u0000~\u0000\u00a1q\u0000~\u0000S"
+"q\u0000~\u0000Yq\u0000~\u0000\\q\u0000~\u0000Zq\u0000~\u0000\u00a3q\u0000~\u0000@q\u0000~\u0000Vq\u0000~\u0000Ux"));
        }
                ...
                switch (state) {
                    case  3 :
                        if (("ClassPolyType" == ___local)&&("http://czt.sourceforge.net/object-z" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.oz.jaxb.gen.impl.ClassPolyTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.oz.jaxb.gen.impl.ClassPolyTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ChannelType" == ___local)&&("http://czt.sourceforge.net/tcoz" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.tcoz.jaxb.gen.impl.ChannelTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.tcoz.jaxb.gen.impl.ChannelTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ClassUnionType" == ___local)&&("http://czt.sourceforge.net/object-z" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("GivenType" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.GivenTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("SchemaType" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.SchemaTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.SchemaTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("GenParamType" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.GenParamTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.GenParamTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ClassRefType" == ___local)&&("http://czt.sourceforge.net/object-z" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ProcessType" == ___local)&&("http://czt.sourceforge.net/circus" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.circus.jaxb.gen.impl.ProcessTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.circus.jaxb.gen.impl.ProcessTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ActionType" == ___local)&&("http://czt.sourceforge.net/circus" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.circus.jaxb.gen.impl.ActionTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.circus.jaxb.gen.impl.ActionTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("PowerType" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.PowerTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.PowerTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ProdType" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.ProdTypeElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.ProdTypeElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        ...
                        if (("Type2" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.Type2ElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.Type2ElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        ...
                        if (("NameNamePair" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getNameNamePair().add(((net.sourceforge.czt.z.jaxb.gen.impl.NameNamePairElementImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.NameNamePairElementImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        state = 6;
                        continue outer;
                    ...
                    case  0 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.z.jaxb.gen.impl.TermAImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((net.sourceforge.czt.z.jaxb.gen.impl.TermAImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                        return ;
                    ...
                    case  7 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl.class), 8, ___uri, ___local, ___qname, __atts)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        continue outer;
                    case  0 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.z.jaxb.gen.impl.TermAImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  9 :
                        attIdx = context.getAttribute("", "Decl");
                        if (attIdx >= 0) {
                        ...
                        return ;
                    case  7 :
                        _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl) spawnChildFromLeaveElement((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  8 :
                        if (("Type2" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            context.popAttributes();
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        continue outer;
                    case  0 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.z.jaxb.gen.impl.TermAImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  9 :
                        ...
                        return ;
                    case  7 :
                        _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        continue outer;
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.z.jaxb.gen.impl.TermAImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  9 :
                        attIdx = context.getAttribute("", "Decl");
                        if (attIdx >= 0) {
                        ...
                        return ;
                    case  7 :
                        _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl) spawnChildFromLeaveAttribute((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  2 :
                            ...
                            continue outer;
                        case  0 :
                            spawnHandlerFromText((((net.sourceforge.czt.z.jaxb.gen.impl.TermAImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassRefImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                        case  9 :
                            attIdx = context.getAttribute("", "Decl");
                            if (attIdx >= 0) {
                            ...
                            return ;
                        case  7 :
                            _getType2().add(((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl) spawnChildFromText((net.sourceforge.czt.z.jaxb.gen.impl.Type2Impl.class), 8, value)));
                            return ;
                    }
