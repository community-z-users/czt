    ...
    extends net.sourceforge.czt.core.jaxb.gen.impl.runtime.DefaultJAXBContextImpl
{
    ...
    public final static net.sourceforge.czt.core.jaxb.gen.impl.runtime.GrammarInfo grammarInfo = new net.sourceforge.czt.core.jaxb.gen.impl.runtime.GrammarInfoImpl(rootTagMap, defaultImplementations, (net.sourceforge.czt.oz.jaxb.gen.ObjectFactory.class));
    ...
    static {
        ...
        defaultImplementations.put((net.sourceforge.czt.oz.jaxb.gen.StringListTypeElement.class), "net.sourceforge.czt.oz.jaxb.gen.impl.StringListTypeElementImpl");
        ...
        defaultImplementations.put((net.sourceforge.czt.oz.jaxb.gen.StringListType.class), "net.sourceforge.czt.oz.jaxb.gen.impl.StringListTypeImpl");
        ...
        rootTagMap.put(new javax.xml.namespace.QName("http://czt.sourceforge.net/object-z", "StringListType"), (net.sourceforge.czt.oz.jaxb.gen.StringListTypeElement.class));
