...
public class PrimaryDeclElementImpl
    extends net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclImpl
    implements net.sourceforge.czt.oz.jaxb.gen.PrimaryDeclElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.oz.jaxb.gen.PrimaryDeclElement.class);
    }
    ...
    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclElementImpl.Unmarshaller(context);
    }
...
+"urceforge.net/zmlq\u0000~\u0000\u001fsq\u0000~\u0000\u000bppsq\u0000~\u0000\u000bppsq\u0000~\u0000\u000bppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000"
+"\u000bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u00007net.sourc"
+"eforge.czt.zpatt.jaxb.gen.JokerDeclListElementq\u0000~\u0000$sq\u0000~\u0000\u0000pp\u0000"
+"sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000.net."
+"sourceforge.czt.z.jaxb.gen.InclDeclElementq\u0000~\u0000$sq\u0000~\u0000\u0000pp\u0000sq\u0000~"
+"\u0000\u000bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000-net.sour"
+"ceforge.czt.z.jaxb.gen.VarDeclElementq\u0000~\u0000$sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bpps"
+"q\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000/net.sourcefor"
+"ge.czt.z.jaxb.gen.ConstDeclElementq\u0000~\u0000$sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq"
+"\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000bPrimaryDeclt\u0000#http://czt.sourceforge."
...
+"/ExpressionPool;xp\u0000\u0000\u0000\u0013\u0001pq\u0000~\u0000\u0015q\u0000~\u0000Eq\u0000~\u0000Kq\u0000~\u0000Qq\u0000~\u0000Wq\u0000~\u0000\nq\u0000~\u0000\u0012q"
+"\u0000~\u0000Dq\u0000~\u0000Jq\u0000~\u0000Pq\u0000~\u0000Vq\u0000~\u0000Bq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000@q\u0000~\u0000%q\u0000~\u0000[q\u0000~\u0000\u0010q\u0000~\u0000Ax"));
        }
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclElementImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclImpl)net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclImpl)net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclImpl)net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclImpl)net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclImpl)net.sourceforge.czt.oz.jaxb.gen.impl.PrimaryDeclElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
