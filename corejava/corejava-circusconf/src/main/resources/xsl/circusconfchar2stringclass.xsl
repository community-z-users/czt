...
/**
 * An interface for commonly used Circus Confidentiality characters.
 *
 * @author generated by Gnast XSL script circustimechar2stringclass.xsl
 */
public interface CircusConfString extends CircusPattString
{
</xsl:text>
...
<xsl:text>
  ...
  String </xsl:text>
    ...
    <xsl:text> = String.valueOf(CircusConfChar.</xsl:text>
    <xsl:value-of select="@id"/>
    <xsl:text>);</xsl:text>
  </xsl:template>
