 ...
 * @author rong ID : 1005450 4th Oct 2007 The dialog provides an interface to
 * select package from local hard drive.
 */
      ...
      ActionListener
{
  ...
  public DialogPackageURLSelection()
  {
    ...
    if (Parameter.getPackageName() != null
        && Parameter.getPackageName().length() > 0)
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (e.getSource() == this.m_butPackageName) {
      ...
      if (m_txtLocation.getText() != null
          && m_txtLocation.getText().length() > 0)
      ...
      if (option == JFileChooser.APPROVE_OPTION) {
        ...
        if (!name.contains(m_txtLocation.getText())) {
          ErrorMessage.DisplayErrorMessage("Invalid package name",
