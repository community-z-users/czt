...
public class DialogCoverageLineColor extends JDialog
{
  ...
  private static final String[] STR_COVERAGE_NAME = 
    {"State","Transition","Transition pair","Action"};
  ...
  private void createComboBoxes()
  {
    for(int i=0;i<Parameter.NUM_COVERAGE;i++)
    {
      ...
      m_comboColorList[i].addItemListener(
          new ItemListener()
          {
  ...
  private Color[] getAvailableColorList(String coverage)
  {
    ...
    Color[] availableColor = 
      new Color[LINE_COVERAG_COLOR.length-Parameter.NUM_COVERAGE+1];
  ...
  private class ComboBoxModel extends DefaultComboBoxModel
  {
    ...
    { 
      ...
      for(int i=0; i<m_color.length; i++)
      {
        ...
        { System.out.println( "found" + m_color.toString()+"number: "+i); return i; }
      }
      return -1;
    }
