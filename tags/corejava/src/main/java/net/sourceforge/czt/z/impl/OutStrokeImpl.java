  ...
  extends StrokeImpl   implements OutStroke
{
  ...
  protected OutStrokeImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof OutStrokeVisitor) {
      OutStrokeVisitor<R> visitor = (OutStrokeVisitor<R>) v;
   ...
   */
  public OutStrokeImpl create(Object[] args)
  {
    OutStrokeImpl zedObject = null;
    try {
      zedObject = new OutStrokeImpl(getFactory());
    }
