  ...
  extends OpExprImpl   implements WaitUntilProExpr
{
  ...
  protected WaitUntilProExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof WaitUntilProExprVisitor) {
      WaitUntilProExprVisitor<R> visitor = (WaitUntilProExprVisitor<R>) v;
   ...
   */
  public WaitUntilProExprImpl create(Object[] args)
  {
    WaitUntilProExprImpl zedObject = null;
    try {
      ...
      zedObject = new WaitUntilProExprImpl(getFactory());
