...
public class SeqOpExprImpl
  extends OpExpr2Impl   implements SeqOpExpr
{
  /**
  ...
  protected SeqOpExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof SeqOpExprVisitor) {
      SeqOpExprVisitor<R> visitor = (SeqOpExprVisitor<R>) v;
   ...
   */
  public SeqOpExprImpl create(Object[] args)
  {
    SeqOpExprImpl zedObject = null;
    try {
      OpExpr leftOpExpr = (OpExpr) args[0];
      OpExpr rightOpExpr = (OpExpr) args[1];
      zedObject = new SeqOpExprImpl(getFactory());
