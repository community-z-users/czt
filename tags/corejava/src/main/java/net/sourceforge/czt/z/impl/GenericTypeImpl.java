  ...
  extends TypeImpl   implements GenericType
{
  ...
  protected GenericTypeImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    GenericTypeImpl zedObject = null;
    try {
      java.util.List<ZDeclName> name = (java.util.List<ZDeclName>) args[0];
      Type2 type = (Type2) args[1];
      Type2 optionalType = (Type2) args[2];
      zedObject = new GenericTypeImpl(getFactory());
      if (name != null) {
  ...
  private ListTerm<ZDeclName> name_ =
    new ListTermImpl<ZDeclName>();

  public ListTerm<ZDeclName> getName()
  {
    return name_;
  }
