...
public abstract class ParProcessIteImpl
  extends ProcessIteImpl   implements ParProcessIte
{
  /**
  ...
  protected ParProcessIteImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof ParProcessIteVisitor) {
      ParProcessIteVisitor<R> visitor = (ParProcessIteVisitor<R>) v;
