...
import net.sourceforge.czt.z.visitor.ZDeclNameListVisitor;
...
public class ZDeclNameListImpl
  extends java.util.AbstractList<DeclName>
  implements ZDeclNameList
{
   ...
   */
  /*@ non_null @*/
  private List<DeclName> list_ = new ArrayList<DeclName>();
   ...
   */
  protected ZDeclNameListImpl()
  {
    factory_ = null;
  }

  protected ZDeclNameListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
   ...
   */
  public void add(int index, DeclName element)
  {
   ...
   *         <code>(index < 0 || index >= size())</code>.
   */
  public DeclName remove(int index)
  {
   ...
   */
  public DeclName set(int index, DeclName element)
  {
  ...
  {
    if (v instanceof ZDeclNameListVisitor) {
      ZDeclNameListVisitor<R> visitor = (ZDeclNameListVisitor<R>) v;
      return visitor.visitZDeclNameList(this);
    }
  ...
  public ZDeclNameListImpl create(Object[] args)
  {
    ZDeclNameListImpl result = new ZDeclNameListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((DeclName) args[i]);
    }
    return result;
  }
}
