...
/**
 * A(n) IntChoiceProcessIte visitor.
 */
public interface IntChoiceProcessIteVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) IntChoiceProcessIte.
   * @param  term the IntChoiceProcessIte to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitIntChoiceProcessIte(IntChoiceProcessIte term);
}
