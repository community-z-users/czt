 ...
 * {@link InterleaveProcessIte}.
 *
 * @author Gnast version 0.1
 */
public class InterleaveProcessIteImpl
  extends ParProcessIteImpl   implements InterleaveProcessIte
{
  /**
  ...
  protected InterleaveProcessIteImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof InterleaveProcessIteVisitor) {
      InterleaveProcessIteVisitor<R> visitor = (InterleaveProcessIteVisitor<R>) v;
