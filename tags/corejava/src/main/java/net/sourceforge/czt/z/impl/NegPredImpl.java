  ...
  extends PredImpl   implements NegPred
{
  ...
  protected NegPredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof NegPredVisitor) {
      NegPredVisitor<R> visitor = (NegPredVisitor<R>) v;
   ...
   */
  public NegPredImpl create(Object[] args)
  {
    NegPredImpl zedObject = null;
    try {
      Pred pred = (Pred) args[0];
      zedObject = new NegPredImpl(getFactory());
