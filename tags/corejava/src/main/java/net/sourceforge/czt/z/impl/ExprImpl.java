...
public abstract class ExprImpl
  extends TermImpl   implements Expr
{
  /**
  ...
  protected ExprImpl(BaseFactory factory)
  {
    super(factory);
  }
   ...
   * also a(n) ExprImpl and all the getter methods except getAnns
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ExprVisitor) {
      ExprVisitor<R> visitor = (ExprVisitor<R>) v;
