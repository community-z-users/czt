...
public class ZRenameListImpl
  extends java.util.AbstractList<NewOldPair>
  implements ZRenameList
{
   ...
   */
  /*@ non_null @*/
  private List<NewOldPair> list_ = new ArrayList<NewOldPair>();
  ...
  protected ZRenameListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
  ...
  public ZRenameList getNewOldPair()
  {
    return this;
  }
   ...
   */
  public void add(int index, NewOldPair element)
  {
   ...
   *         <code>(index < 0 || index >= size())</code>.
   */
  public NewOldPair get(int index)
  {
   ...
   *         <code>(index < 0 || index >= size())</code>.
   */
  public NewOldPair remove(int index)
  {
   ...
   */
  public NewOldPair set(int index, NewOldPair element)
  {
  ...
  {
    if (v instanceof ZRenameListVisitor) {
      ZRenameListVisitor<R> visitor = (ZRenameListVisitor<R>) v;
