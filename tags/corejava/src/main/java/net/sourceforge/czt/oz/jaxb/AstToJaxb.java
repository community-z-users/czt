             ...
             net.sourceforge.czt.base.visitor.TermVisitor
{
  ...
  public Object visitClassRefType(net.sourceforge.czt.oz.ast.ClassRefType zedObject)
  {
    ...
    try {
      ...
      {
        List list = zedObject.getPrimary();
        List newlist = jaxbObject.getPrimary();
        for (Iterator iter = list.iterator(); iter.hasNext();) {
          Object o = iter.next();
          if (o instanceof Term) {
            createElement_ = false;
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a ClassRefType to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitVisibilityList(net.sourceforge.czt.oz.ast.VisibilityList zedObject)
  {
    ...
    try {
      ...
      {
        List list = zedObject.getZRefName();
        List newlist = jaxbObject.getZRefName();
        for (Iterator iter = list.iterator(); iter.hasNext();) {
          Object o = iter.next();
          if (o instanceof Term) {
            createElement_ = true;
  ...
  public Object visitPolyExpr(net.sourceforge.czt.oz.ast.PolyExpr zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a PolyExpr to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitNameSignaturePair(net.sourceforge.czt.oz.ast.NameSignaturePair zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a NameSignaturePair to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitClassSig(net.sourceforge.czt.oz.ast.ClassSig zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a ClassSig to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitOpText(net.sourceforge.czt.oz.ast.OpText zedObject)
  {
    ...
    try {
      ...
      if (zedObject.getDeltaList() != null) {
        ...
        jaxbObject.setDeltaList((DeltaList) term.accept(this));
      }
      createElement_ = true;
      if (zedObject.getSchText() != null) {
        Term term = zedObject.getSchText();
  ...
  public Object visitDeltaList(net.sourceforge.czt.oz.ast.DeltaList zedObject)
  {
    getLogger().entering(getClassName(), "visitDeltaList", zedObject);

    DeltaList jaxbObject = null;
    try {
      jaxbObject = objectFactory_.createDeltaListElement();
      if (!createElement_) {
        jaxbObject = objectFactory_.createDeltaList();
      }
      {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a DeltaList to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitState(net.sourceforge.czt.oz.ast.State zedObject)
  {
    ...
    try {
      ...
      if (zedObject.getPrimaryDecl() != null) {
        ...
        jaxbObject.setPrimaryDecl((PrimaryDecl) term.accept(this));
      }
      createElement_ = true;
      if (zedObject.getSecondaryDecl() != null) {
        Term term = zedObject.getSecondaryDecl();
        jaxbObject.setSecondaryDecl((SecondaryDecl) term.accept(this));
      }
      createElement_ = true;
  ...
  public Object visitClassPara(net.sourceforge.czt.oz.ast.ClassPara zedObject)
  {
    ...
    try {
      ...
      if (zedObject.getInheritedClass() != null) {
        Term term = zedObject.getInheritedClass();
        jaxbObject.setInheritedClass((ExprList) term.accept(this));
      }
      {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a ClassPara to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitOperation(net.sourceforge.czt.oz.ast.Operation zedObject)
  {
    ...
    try {
      ...
      if (zedObject.getOpName() != null) {
        ...
        jaxbObject.setOpName((DeclName) term.accept(this));
      }
      createElement_ = true;
      if (zedObject.getOpExpr() != null) {
        Term term = zedObject.getOpExpr();
  ...
  public Object visitClassPolyType(net.sourceforge.czt.oz.ast.ClassPolyType zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a ClassPolyType to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitContainmentExpr(net.sourceforge.czt.oz.ast.ContainmentExpr zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a ContainmentExpr to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitClassUnionExpr(net.sourceforge.czt.oz.ast.ClassUnionExpr zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a ClassUnionExpr to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitPredExpr(net.sourceforge.czt.oz.ast.PredExpr zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a PredExpr to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitClassUnionType(net.sourceforge.czt.oz.ast.ClassUnionType zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a ClassUnionType to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
