  ...
  extends SchExpr2Impl   implements ProjExpr
{
  ...
  protected ProjExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ProjExprVisitor) {
      ProjExprVisitor<R> visitor = (ProjExprVisitor<R>) v;
   ...
   */
  public ProjExprImpl create(Object[] args)
  {
    ProjExprImpl zedObject = null;
    try {
      Expr leftExpr = (Expr) args[0];
      Expr rightExpr = (Expr) args[1];
      zedObject = new ProjExprImpl(getFactory());
