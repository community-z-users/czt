...
public abstract class ActionDImpl
  extends Action1Impl   implements ActionD
{
  /**
  ...
  protected ActionDImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof ActionDVisitor) {
      ActionDVisitor<R> visitor = (ActionDVisitor<R>) v;
