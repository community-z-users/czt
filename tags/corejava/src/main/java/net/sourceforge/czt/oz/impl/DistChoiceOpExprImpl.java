  ...
  extends DistOpExprImpl   implements DistChoiceOpExpr
{
  ...
  protected DistChoiceOpExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof DistChoiceOpExprVisitor) {
      DistChoiceOpExprVisitor<R> visitor = (DistChoiceOpExprVisitor<R>) v;
   ...
   */
  public DistChoiceOpExprImpl create(Object[] args)
  {
    DistChoiceOpExprImpl zedObject = null;
    try {
      net.sourceforge.czt.z.ast.SchText schText = (net.sourceforge.czt.z.ast.SchText) args[0];
      OpExpr opExpr = (OpExpr) args[1];
      zedObject = new DistChoiceOpExprImpl(getFactory());
