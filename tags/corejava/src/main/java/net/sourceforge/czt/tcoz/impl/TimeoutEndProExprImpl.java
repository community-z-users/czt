  ...
  extends OpExprImpl   implements TimeoutEndProExpr
{
  ...
  protected TimeoutEndProExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof TimeoutEndProExprVisitor) {
      TimeoutEndProExprVisitor<R> visitor = (TimeoutEndProExprVisitor<R>) v;
   ...
   */
  public TimeoutEndProExprImpl create(Object[] args)
  {
    TimeoutEndProExprImpl zedObject = null;
    try {
      ...
      zedObject = new TimeoutEndProExprImpl(getFactory());
