 ...
 */
public interface Freetype extends Term
{
  ...
  /**
   * Returns the BranchList element.
   *
   * @return the BranchList element.
   */
  BranchList getBranchList();


  /**
   * Sets the BranchList element.
   *
   * @param branchList   the BranchList element.
   * @see #getBranchList
   */
  void setBranchList(BranchList branchList);
