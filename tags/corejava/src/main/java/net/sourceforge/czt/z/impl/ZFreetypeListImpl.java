...
public class ZFreetypeListImpl
  extends java.util.AbstractList<Freetype>
  implements ZFreetypeList
{
   ...
   */
  /*@ non_null @*/
  private List<Freetype> list_ = new ArrayList<Freetype>();
   ...
   */
  protected ZFreetypeListImpl()
  {
    factory_ = null;
  }

  protected ZFreetypeListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
  ...
  public ZFreetypeList getFreetype()
  {
    return this;
  }
   ...
   */
  public void add(int index, Freetype element)
  {
   ...
   *         <code>(index < 0 || index >= size())</code>.
   */
  public Freetype remove(int index)
  {
   ...
   */
  public Freetype set(int index, Freetype element)
  {
  ...
  {
    if (v instanceof ZFreetypeListVisitor) {
      ZFreetypeListVisitor<R> visitor = (ZFreetypeListVisitor<R>) v;
      return visitor.visitZFreetypeList(this);
    }
  ...
  public ZFreetypeListImpl create(Object[] args)
  {
    ZFreetypeListImpl result = new ZFreetypeListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((Freetype) args[i]);
    }
    return result;
  }
}
