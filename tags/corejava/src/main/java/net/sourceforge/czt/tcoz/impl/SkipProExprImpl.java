  ...
  extends OpExprImpl   implements SkipProExpr
{
  ...
  protected SkipProExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof SkipProExprVisitor) {
      SkipProExprVisitor<R> visitor = (SkipProExprVisitor<R>) v;
   ...
   */
  public SkipProExprImpl create(Object[] args)
  {
    SkipProExprImpl zedObject = null;
    try {
      zedObject = new SkipProExprImpl(getFactory());
    }
