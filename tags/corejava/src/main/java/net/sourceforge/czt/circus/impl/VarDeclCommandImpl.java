...
public class VarDeclCommandImpl
  extends CircusCommandImpl   implements VarDeclCommand
{
  /**
  ...
  protected VarDeclCommandImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof VarDeclCommandVisitor) {
      VarDeclCommandVisitor<R> visitor = (VarDeclCommandVisitor<R>) v;
