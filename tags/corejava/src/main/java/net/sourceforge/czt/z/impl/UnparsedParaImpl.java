  ...
  extends ParaImpl   implements UnparsedPara
{
  ...
  protected UnparsedParaImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof UnparsedParaVisitor) {
      UnparsedParaVisitor<R> visitor = (UnparsedParaVisitor<R>) v;
   ...
   */
  public UnparsedParaImpl create(Object[] args)
  {
    UnparsedParaImpl zedObject = null;
    try {
      java.util.List content = (java.util.List) args[0];
      zedObject = new UnparsedParaImpl(getFactory());
