  ...
  extends OpExprImpl   implements RecProExpr
{
  ...
  protected RecProExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof RecProExprVisitor) {
      RecProExprVisitor<R> visitor = (RecProExprVisitor<R>) v;
   ...
   */
  public RecProExprImpl create(Object[] args)
  {
    RecProExprImpl zedObject = null;
    try {
      ...
      zedObject = new RecProExprImpl(getFactory());
