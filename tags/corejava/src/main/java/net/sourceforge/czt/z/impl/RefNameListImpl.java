...
import net.sourceforge.czt.z.visitor.RefNameListVisitor;
 ...
 */
public abstract class RefNameListImpl
  extends TermImpl   implements RefNameList
{
  /**
  ...
  protected RefNameListImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof RefNameListVisitor) {
      RefNameListVisitor<R> visitor = (RefNameListVisitor<R>) v;
