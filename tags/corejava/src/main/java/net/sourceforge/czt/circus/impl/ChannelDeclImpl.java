...
public class ChannelDeclImpl
  extends DeclImpl   implements ChannelDecl
{
  /**
  ...
  protected ChannelDeclImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof ChannelDeclVisitor) {
      ChannelDeclVisitor<R> visitor = (ChannelDeclVisitor<R>) v;
  ...
  public ChannelDeclImpl create(Object[] args)
  {
    ...
    try {
      ...
      net.sourceforge.czt.z.ast.DeclNameList declNameList = (net.sourceforge.czt.z.ast.DeclNameList) args[1];
      net.sourceforge.czt.z.ast.Expr expr = (net.sourceforge.czt.z.ast.Expr) args[2];
  ...
  {
    Object[] erg = { getGenFormals(), getDeclNameList(), getExpr() };
    return erg;
  }
