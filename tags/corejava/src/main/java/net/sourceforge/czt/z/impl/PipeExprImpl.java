  ...
  extends SchExpr2Impl   implements PipeExpr
{
  ...
  protected PipeExprImpl(BaseFactory factory)
  {
    super(factory);
  }
   ...
   * also a(n) PipeExprImpl and all the getter methods except getAnns
  ...
  /**
   * Returns the hash code value for this PipeExprImpl.
   */
  public int hashCode()
  {
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof PipeExprVisitor) {
      PipeExprVisitor<R> visitor = (PipeExprVisitor<R>) v;
   ...
   */
  public PipeExprImpl create(Object[] args)
  {
    PipeExprImpl zedObject = null;
    try {
      Expr leftExpr = (Expr) args[0];
      Expr rightExpr = (Expr) args[1];
      zedObject = new PipeExprImpl(getFactory());
