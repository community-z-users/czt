...
public class DeductionImpl
  extends TermImpl   implements Deduction
{
  /**
  ...
  protected DeductionImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof DeductionVisitor) {
      DeductionVisitor<R> visitor = (DeductionVisitor<R>) v;
   ...
   */
  public DeductionImpl create(Object[] args)
  {
    DeductionImpl zedObject = null;
    try {
      java.util.List<Binding> binding = (java.util.List<Binding>) args[0];
      java.util.List<Sequent> sequent = (java.util.List<Sequent>) args[1];
      String name = (String) args[2];
      zedObject = new DeductionImpl(getFactory());
      if (binding != null) {
