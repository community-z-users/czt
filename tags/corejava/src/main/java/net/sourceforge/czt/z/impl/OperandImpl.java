  ...
  extends OperImpl   implements Operand
{
  ...
  protected OperandImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof OperandVisitor) {
      OperandVisitor<R> visitor = (OperandVisitor<R>) v;
   ...
   */
  public OperandImpl create(Object[] args)
  {
    OperandImpl zedObject = null;
    try {
      Boolean list = (Boolean) args[0];
      zedObject = new OperandImpl(getFactory());
