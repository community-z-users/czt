  ...
  extends SchExpr2Impl   implements AndExpr
{
  ...
  protected AndExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof AndExprVisitor) {
      AndExprVisitor<R> visitor = (AndExprVisitor<R>) v;
   ...
   */
  public AndExprImpl create(Object[] args)
  {
    AndExprImpl zedObject = null;
    try {
      Expr leftExpr = (Expr) args[0];
      Expr rightExpr = (Expr) args[1];
      zedObject = new AndExprImpl(getFactory());
