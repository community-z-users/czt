...
public class ZBranchListImpl
  extends java.util.AbstractList<Branch>
  implements ZBranchList
{
   ...
   */
  /*@ non_null @*/
  private List<Branch> list_ = new ArrayList<Branch>();
   ...
   */
  protected ZBranchListImpl()
  {
    factory_ = null;
  }

  protected ZBranchListImpl(BaseFactory factory)
  {
    super();
    factory_ = factory;
  }
  ...
  {
    if (v instanceof ZBranchListVisitor) {
      ZBranchListVisitor<R> visitor = (ZBranchListVisitor<R>) v;
      return visitor.visitZBranchList(this);
    }
  ...
  public ZBranchListImpl create(Object[] args)
  {
    ZBranchListImpl result = new ZBranchListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((Branch) args[i]);
    }
    return result;
  }
}
