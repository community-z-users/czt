...
public class TimeoutStartProExprImpl
  extends OpExprImpl   implements TimeoutStartProExpr
{
  /**
  ...
  protected TimeoutStartProExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof TimeoutStartProExprVisitor) {
      TimeoutStartProExprVisitor<R> visitor = (TimeoutStartProExprVisitor<R>) v;
   ...
   */
  public TimeoutStartProExprImpl create(Object[] args)
  {
    TimeoutStartProExprImpl zedObject = null;
    try {
      ...
      zedObject = new TimeoutStartProExprImpl(getFactory());
