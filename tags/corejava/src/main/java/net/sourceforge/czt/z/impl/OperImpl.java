  ...
  extends TermImpl   implements Oper
{
  ...
  protected OperImpl(BaseFactory factory)
  {
    super(factory);
  }
   ...
   * also a(n) OperImpl and all the getter methods except getAnns
  ...
  {
    if (v instanceof OperVisitor) {
      OperVisitor<R> visitor = (OperVisitor<R>) v;
