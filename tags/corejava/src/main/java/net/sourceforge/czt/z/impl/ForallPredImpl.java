  ...
  extends QntPredImpl   implements ForallPred
{
  ...
  protected ForallPredImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof ForallPredVisitor) {
      ForallPredVisitor<R> visitor = (ForallPredVisitor<R>) v;
   ...
   */
  public ForallPredImpl create(Object[] args)
  {
    ForallPredImpl zedObject = null;
    try {
      SchText schText = (SchText) args[0];
      Pred pred = (Pred) args[1];
      zedObject = new ForallPredImpl(getFactory());
