 ...
 */
public abstract class ParActionImpl
  extends Action2Impl   implements ParAction
{
  /**
   ...
   */
  protected ParActionImpl()
  {
  }

  protected ParActionImpl(BaseFactory factory)
  {
    super(factory);
  }
   ...
   * also a(n) ParActionImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ParActionImpl object = (ParActionImpl) obj;
  ...
  public int hashCode()
  {
    ...
    hashCode += "ParActionImpl".hashCode();
    if (leftNameSet_ != null) {
  ...
  {
    if (v instanceof ParActionVisitor) {
      ParActionVisitor<R> visitor = (ParActionVisitor<R>) v;
      return visitor.visitParAction(this);
    }
