...
public abstract class ParProcessIdxImpl
  extends ProcessIdxImpl   implements ParProcessIdx
{
  /**
  ...
  protected ParProcessIdxImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof ParProcessIdxVisitor) {
      ParProcessIdxVisitor<R> visitor = (ParProcessIdxVisitor<R>) v;
