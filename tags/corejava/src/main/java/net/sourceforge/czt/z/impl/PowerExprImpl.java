  ...
  extends Expr1Impl   implements PowerExpr
{
  ...
  protected PowerExprImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof PowerExprVisitor) {
      PowerExprVisitor<R> visitor = (PowerExprVisitor<R>) v;
   ...
   */
  public PowerExprImpl create(Object[] args)
  {
    PowerExprImpl zedObject = null;
    try {
      Expr expr = (Expr) args[0];
      zedObject = new PowerExprImpl(getFactory());
