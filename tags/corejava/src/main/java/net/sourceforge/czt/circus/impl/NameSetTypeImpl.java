...
public class NameSetTypeImpl
  extends Type2Impl   implements NameSetType
{
  /**
  ...
  protected NameSetTypeImpl(BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof NameSetTypeVisitor) {
      NameSetTypeVisitor<R> visitor = (NameSetTypeVisitor<R>) v;
