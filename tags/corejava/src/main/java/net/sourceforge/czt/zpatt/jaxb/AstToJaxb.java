             ...
             net.sourceforge.czt.base.visitor.TermVisitor
{
  ...
  public Object visitJokerExprListBinding(net.sourceforge.czt.zpatt.ast.JokerExprListBinding zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerExprListBinding to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerExprBinding(net.sourceforge.czt.zpatt.ast.JokerExprBinding zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerExprBinding to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerDeclNameBinding(net.sourceforge.czt.zpatt.ast.JokerDeclNameBinding zedObject)
  {
    getLogger().entering(getClassName(), "visitJokerDeclNameBinding", zedObject);

    JokerDeclNameBinding jaxbObject = null;
    try {
      jaxbObject = objectFactory_.createJokerDeclNameBindingElement();
      if (!createElement_) {
        jaxbObject = objectFactory_.createJokerDeclNameBinding();
      }
      createElement_ = true;
      if (zedObject.getJokerDeclName() != null) {
        Term term = zedObject.getJokerDeclName();
        jaxbObject.setJokerDeclName((JokerDeclName) term.accept(this));
      }
      createElement_ = true;
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform a JokerDeclNameBinding to the corresponding "
        + "Jaxb class";
      throw new CztException(message, exception);
    }
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerDeclNameBinding to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }

    getLogger().exiting(getClassName(), "visitJokerDeclNameBinding", jaxbObject);
    createElement_ = true;
    return jaxbObject;
  }
  ...
  public Object visitJokerRefNameBinding(net.sourceforge.czt.zpatt.ast.JokerRefNameBinding zedObject)
  {
    getLogger().entering(getClassName(), "visitJokerRefNameBinding", zedObject);

    JokerRefNameBinding jaxbObject = null;
    try {
      jaxbObject = objectFactory_.createJokerRefNameBindingElement();
      if (!createElement_) {
        jaxbObject = objectFactory_.createJokerRefNameBinding();
      }
      createElement_ = true;
      if (zedObject.getJokerRefName() != null) {
        Term term = zedObject.getJokerRefName();
        jaxbObject.setJokerRefName((JokerRefName) term.accept(this));
      }
      createElement_ = true;
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform a JokerRefNameBinding to the corresponding "
        + "Jaxb class";
      throw new CztException(message, exception);
    }
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerRefNameBinding to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }

    getLogger().exiting(getClassName(), "visitJokerRefNameBinding", jaxbObject);
    createElement_ = true;
    return jaxbObject;
  }
  ...
  public Object visitRule(net.sourceforge.czt.zpatt.ast.Rule zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a Rule to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitTypeProviso(net.sourceforge.czt.zpatt.ast.TypeProviso zedObject)
  {
    ...
    try {
      ...
      if (zedObject.getType() != null) {
        ...
        jaxbObject.setType((Expr) term.accept(this));
      }
    }
    catch (Exception exception) {
      String message =
  ...
  public Object visitJokerRefName(net.sourceforge.czt.zpatt.ast.JokerRefName zedObject)
  {
    getLogger().entering(getClassName(), "visitJokerRefName", zedObject);

    JokerRefName jaxbObject = null;
    try {
      jaxbObject = objectFactory_.createJokerRefNameElement();
      if (!createElement_) {
        jaxbObject = objectFactory_.createJokerRefName();
      }
      createElement_ = false;
      if (zedObject.getName() != null) {
        jaxbObject.setName(zedObject.getName());
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform a JokerRefName to the corresponding "
        + "Jaxb class";
      throw new CztException(message, exception);
    }
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerRefName to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }

    getLogger().exiting(getClassName(), "visitJokerRefName", jaxbObject);
    createElement_ = true;
    return jaxbObject;
  }
  ...
  public Object visitJokers(net.sourceforge.czt.zpatt.ast.Jokers zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a Jokers to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerPred(net.sourceforge.czt.zpatt.ast.JokerPred zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerPred to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerPredBinding(net.sourceforge.czt.zpatt.ast.JokerPredBinding zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerPredBinding to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerExpr(net.sourceforge.czt.zpatt.ast.JokerExpr zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerExpr to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerExprList(net.sourceforge.czt.zpatt.ast.JokerExprList zedObject)
  {
    ...
    try {
      ...
      createElement_ = true;
      if (zedObject.getZExprList() != null) {
        Term term = zedObject.getZExprList();
        jaxbObject.setZExprList((ZExprList) term.accept(this));
      }
      createElement_ = false;
      if (zedObject.getName() != null) {
        jaxbObject.setName(zedObject.getName());
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerExprList to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitSequentContext(net.sourceforge.czt.zpatt.ast.SequentContext zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a SequentContext to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitHeadDeclList(net.sourceforge.czt.zpatt.ast.HeadDeclList zedObject)
  {
    getLogger().entering(getClassName(), "visitHeadDeclList", zedObject);

    HeadDeclList jaxbObject = null;
    try {
      jaxbObject = objectFactory_.createHeadDeclListElement();
      if (!createElement_) {
        jaxbObject = objectFactory_.createHeadDeclList();
      }
      createElement_ = true;
      if (zedObject.getZDeclList() != null) {
        Term term = zedObject.getZDeclList();
        jaxbObject.setZDeclList((ZDeclList) term.accept(this));
      }
      createElement_ = true;
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a HeadDeclList to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerDeclList(net.sourceforge.czt.zpatt.ast.JokerDeclList zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerDeclList to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerDeclListBinding(net.sourceforge.czt.zpatt.ast.JokerDeclListBinding zedObject)
  {
    ...
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerDeclListBinding to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }
  ...
  public Object visitJokerDeclName(net.sourceforge.czt.zpatt.ast.JokerDeclName zedObject)
  {
    getLogger().entering(getClassName(), "visitJokerDeclName", zedObject);

    JokerDeclName jaxbObject = null;
    try {
      jaxbObject = objectFactory_.createJokerDeclNameElement();
      if (!createElement_) {
        jaxbObject = objectFactory_.createJokerDeclName();
      }
      createElement_ = false;
      if (zedObject.getName() != null) {
        jaxbObject.setName(zedObject.getName());
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform a JokerDeclName to the corresponding "
        + "Jaxb class";
      throw new CztException(message, exception);
    }
    try {
      ...
      String message =
        "class AstToJaxb: "
        + "Cannot transform annotations of a JokerDeclName to the corresponding "
        + "Jaxb class";
      getLogger().warning(message);
      // throw new CztException(message, exception);
    }

    getLogger().exiting(getClassName(), "visitJokerDeclName", jaxbObject);
    createElement_ = true;
    return jaxbObject;
  }
}
