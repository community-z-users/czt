  ...
  extends ParaImpl   implements OptempPara
{
  ...
  public <R> R accept(net.sourceforge.czt.util.Visitor<R> v)
  {
    if (v instanceof OptempParaVisitor) {
      OptempParaVisitor<R> visitor = (OptempParaVisitor<R>) v;
  ...
  public OptempParaImpl create(Object[] args)
  {
    ...
    try {
      java.util.List<Oper> oper = (java.util.List<Oper>) args[0];
      Cat cat = (Cat) args[1];
      Assoc assoc = (Assoc) args[2];
      java.math.BigInteger prec = (java.math.BigInteger) args[3];
  ...
  private java.math.BigInteger prec_;
  ...
  public void setPrec(java.math.BigInteger prec)
  {
    prec_ = prec;
  }
