 ...
 */
public interface IfGuardedCommand extends CircusCommand
{

  /**
   * <p>Returns the GuardedAction elements.</p>
   * <p>To add or remove elements, use the methods provided by
   * the List interface (that's why there is no need for a setter
   * method).</p>
   *
   * @return a list of GuardedAction elements.
   */
  net.sourceforge.czt.base.ast.ListTerm<GuardedAction> getGuardedAction();
}
