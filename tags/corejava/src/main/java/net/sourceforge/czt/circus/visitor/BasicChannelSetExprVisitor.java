...
/**
 * A(n) BasicChannelSetExpr visitor.
 */
public interface BasicChannelSetExprVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) BasicChannelSetExpr.
   * @param  term the BasicChannelSetExpr to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitBasicChannelSetExpr(BasicChannelSetExpr term);
}
