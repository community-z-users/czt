...
public class ClassUnionTypeImpl
    ...
    implements net.sourceforge.czt.oz.jaxb.gen.ClassUnionType, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sourceforge.czt.oz.jaxb.gen.ClassUnionType.class);
    }

    public net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallingContext context) {
        return new net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeImpl.Unmarshaller(context);
    }
...
+"~\u0000\u0005x"));
        ...
        extends net.sourceforge.czt.circus.jaxb.gen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  0 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            spawnHandlerFromEnterElement((((net.sourceforge.czt.oz.jaxb.gen.impl.ClassTypeImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveElement((((net.sourceforge.czt.oz.jaxb.gen.impl.ClassTypeImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromEnterAttribute((((net.sourceforge.czt.oz.jaxb.gen.impl.ClassTypeImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((net.sourceforge.czt.oz.jaxb.gen.impl.ClassTypeImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  1 :
                            ...
                            return ;
                        case  0 :
                            spawnHandlerFromText((((net.sourceforge.czt.oz.jaxb.gen.impl.ClassTypeImpl)net.sourceforge.czt.oz.jaxb.gen.impl.ClassUnionTypeImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                    }
