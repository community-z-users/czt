    ...
    implements net.sourceforge.czt.circus.jaxb.gen.ChannelPara, com.sun.xml.bind.JAXBObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.UnmarshallableObject, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.XMLSerializable, net.sourceforge.czt.circus.jaxb.gen.impl.runtime.ValidatableObject
{
    ...
    protected net.sourceforge.czt.z.jaxb.gen.DeclList _ChannelDecl;
    ...
    public net.sourceforge.czt.z.jaxb.gen.DeclList getChannelDecl() {
        return _ChannelDecl;
    }

    public void setChannelDecl(net.sourceforge.czt.z.jaxb.gen.DeclList value) {
        _ChannelDecl = value;
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ChannelDecl), "ChannelDecl");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ChannelDecl), "ChannelDecl");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _ChannelDecl), "ChannelDecl");
        context.endElement();
    }
...
+"lListq\u0000~\u0000\"sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0014q\u0000~\u0000\rpq\u0000~\u0000(q\u0000~\u00008q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000bChanne"
+"lDeclt\u0000!http://czt.sourceforge.net/circussr\u0000\"com.sun.msv.gra"
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        if (("Anns" == ___local)&&("http://czt.sourceforge.net/zml" == ___uri)) {
                            _ChannelDecl = ((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl.class), 3, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _ChannelDecl = ((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl) spawnChildFromEnterElement((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl.class), 3, ___uri, ___local, ___qname, __atts));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  2 :
                        _ChannelDecl = ((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl) spawnChildFromLeaveElement((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl.class), 3, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  2 :
                        _ChannelDecl = ((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl) spawnChildFromEnterAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl.class), 3, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  4 :
                        ...
                        return ;
                    case  2 :
                        _ChannelDecl = ((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl) spawnChildFromLeaveAttribute((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl.class), 3, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  4 :
                            ...
                            return ;
                        case  2 :
                            _ChannelDecl = ((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl) spawnChildFromText((net.sourceforge.czt.z.jaxb.gen.impl.DeclListImpl.class), 3, value));
                            return ;
                    }
