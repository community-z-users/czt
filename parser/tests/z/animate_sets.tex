% This is an input file for CZT, to test basic set operations.
%
...
\begin{zed} \vdash?  (1 \upto 3) \cap (-3 \upto 0) = \{\} \end{zed}
\begin{zed} \vdash?  (1 \upto 3) \cap (0 \upto -1) = \{\} \end{zed}
% on infinite integer ranges
\begin{zed} \vdash?  \nat \cap (4 \upto 6) = \{4,5,6\} \end{zed}
\begin{zed} \vdash?  \nat \cap (-3 \upto 0) = \{0\} \end{zed}
\begin{zed} \vdash?  \nat \cap (-3 \upto -1) = \{\} \end{zed}
\begin{zed} \vdash?  \num \cap \nat = \nat \end{zed}
\begin{zed} \vdash?  \nat \cap \nat_1 = \nat_1 \end{zed}
% TODO: add cases like:
%         (? < 3) \cap \nat = \{0,1,2\}
...
\begin{zed} \vdash?  \{ x,y:\nat | x+y = 2 \land x \leq 4 \} = \{(0,2),(1,1),(2,0)\} \end{zed}
\begin{zed} \vdash?  \{ x,y:\nat | x+y = 2 \land y \leq 4 \} = \{(0,2),(1,1),(2,0)\} \end{zed}
\begin{zed} \vdash?  \{ x,y:\nat | x-y = 1 \land 2 \geq y \} = \{(3,2),(2,1),(1,0)\} \end{zed}
\begin{zed} \vdash?  \{ x,y:\nat | x-y = 1 \land 2 \geq x \} = \{(1,0),(2,1)\} \end{zed}
...
% TODO: improve reordering so these work?
...
\begin{zed} \vdash?  \# \{x:-10 \upto -1 | x < 0 \land x > -2\} = 1 \end{zed}
%            3. integer range with negative element
\begin{zed} \vdash?  \# (-2 \upto -1) = 2 \end{zed}
