...
\begin{zed} \vdash? \langle 1 \rangle \in \seq (1 \upto 5) \end{zed}
     3. STRATEGY: type-based selection - multi-element sequence
\begin{zed} \vdash? \langle 1, 2 \rangle \in \seq \nat \end{zed}
\begin{zed} \vdash? \langle 1, 2 \rangle \in \seq (1 \upto 5) \end{zed}
\begin{zed} \vdash? \langle 1, 6 \rangle \notin \seq (1 \upto 5) \end{zed}
...
\begin{zed} \vdash? \langle 1 \rangle \in \iseq (1 \upto 5) \end{zed}
     3. STRATEGY: type-based selection - multi-element sequence
\begin{zed} \vdash? \langle 1, 2 \rangle \in \iseq \nat \end{zed}
\begin{zed} \vdash? \langle 1, 2 \rangle \in \iseq (1 \upto 5) \end{zed}
\begin{zed} \vdash? \langle 1, 6 \rangle \notin \iseq (1 \upto 5) \end{zed}
     4. meaning of iseq
\begin{zed} \vdash? \langle 3, 3 \rangle \notin \iseq \nat \end{zed}
...
\begin{zed} \vdash? \langle 1 \rangle \in \seq_1 (1 \upto 5) \end{zed}
     3. STRATEGY: type-based selection - multi-element sequence
\begin{zed} \vdash? \langle 1, 2 \rangle \in \seq_1 \nat \end{zed}
\begin{zed} \vdash? \langle 1, 2 \rangle \in \seq_1 (1 \upto 5) \end{zed}
...
\begin{zed} \vdash? \langle \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \langle 1 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \langle 3 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \langle 5 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \langle 1,3 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \langle 3,5 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \langle 1,3,5 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \lnot \langle 1,5 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
\begin{zed} \vdash? \lnot \langle 3,3 \rangle  \in   \langle 1,3,5 \rangle \end{zed}
