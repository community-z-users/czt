...
\begin{zed} \vdash? \langle 1 \rangle \infix \seq \nat \end{zed}
\begin{zed} \vdash? \langle 1 \rangle \infix \seq (1 \upto 5) \end{zed}
     3. STRATEGY: type-based selection - multi-element sequence
\begin{zed} \vdash? \langle 1, 2 \rangle \infix \seq \nat \end{zed}
\begin{zed} \vdash? \langle 1, 2 \rangle \infix \seq (1 \upto 5) \end{zed}
...
\begin{zed} \vdash? \langle \rangle \infix \iseq \langle \rangle \end{zed}
     2. STRATEGY: type-based selection - single-element sequence
\begin{zed} \vdash? \langle 1 \rangle \infix \iseq \nat \end{zed}
\begin{zed} \vdash? \langle 1 \rangle \infix \iseq (1 \upto 5) \end{zed}
     3. STRATEGY: type-based selection - multi-element sequence
\begin{zed} \vdash? \langle 1, 2 \rangle \infix \iseq \nat \end{zed}
\begin{zed} \vdash? \langle 1, 2 \rangle \infix \iseq (1 \upto 5) \end{zed}
...
\begin{zed} \vdash? \langle \rangle \notin \seq_1 \langle \rangle \end{zed}
     2. STRATEGY: type-based selection - single-element sequence
\begin{zed} \vdash? \langle 1 \rangle \infix \seq_1 \nat \end{zed}
\begin{zed} \vdash? \langle 1 \rangle \infix \seq_1 (1 \upto 5) \end{zed}
     3. STRATEGY: type-based selection - multi-element sequence
\begin{zed} \vdash? \langle 1, 2 \rangle \infix \seq_1 \nat \end{zed}
\begin{zed} \vdash? \langle 1, 2 \rangle \infix \seq_1 (1 \upto 5) \end{zed}
