...
In this file, we explain the various aspect of \Circus\ related to process
...
In \Circus\ processes are global paragraphs at section level. Other global
paragraphs are channel, channel sets, and all other Z paragraphs. Firstly, we
...
\begin{circus}
    \circchannelset CS1 == \lchanset a, b \rchanset \\ % \cup \lchanset c \rchanset \\
