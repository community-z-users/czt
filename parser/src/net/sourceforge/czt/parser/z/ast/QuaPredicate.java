...
public class QuaPredicate implements Predicate{
	public SchemaText st;
	public Predicate p;
	public String flag;
	public QuaPredicate(String s, SchemaText st, Predicate p){
		flag = s;
		this.st = st;
		this.p = p;
	}
	public String toString(){
		return "Qualification predicate: " + flag + " with schematext: "+ st
			+ " @ " + p;
	}
}
