...
public class TupleSelExpression implements Expression{
	public Expression e;
	public String n;
	public TupleSelExpression(Expression e, String n){
		this.e = e;
		this.n = n;
	}
	public String toString(){
		return "TupleSelExpression with expression : "+ e + " . and number : " + n;
	}
}
