...
public class ReNameExpression implements Expression{
	public Expression e;
	public Vector rnl;
	public ReNameExpression(Expression e, Vector rnl){
		this.e = e;
		this.rnl = rnl;
	}
	public String toString(){
		return "ReNameExpression with expression : " + e
		+ " [ renamelist: "+ rnl.toString() + " ] ";
	}
}
