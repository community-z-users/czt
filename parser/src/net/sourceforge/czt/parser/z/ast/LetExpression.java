...
/**
 * LetExpression class implements the abstract class Expression.
 * It represents the substitution expression.
 *
 */
public class LetExpression implements Expression{
	public Vector eql;
	public Expression e;
	public LetExpression(Vector eql, Expression e){
		this.eql = eql;
		this.e = e;
	}
	public String toString(){
		return "LetExpression with let : "+ eql.toString()
		 + " @ Expression: "+ e;
	}
}
