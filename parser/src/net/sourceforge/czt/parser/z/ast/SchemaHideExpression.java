...
public class SchemaHideExpression implements Expression{
	public Expression e;
	public Vector namelist;
	public SchemaHideExpression(Expression e, Vector nl){
		this.e = e;
		namelist = nl;
	}
	public String toString(){
		return "SchemaExpression expression: " + e
		+ " with hiding namelist: " + namelist.toString();
	}
}
