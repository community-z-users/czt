...
public class NofixApp implements Application{
	public Expression e;
	public String s1, s2;
	public NofixApp(String s1, String s2, Expression e){
		this.s1 = s1;
		this.s2 = s2;
		this.e = e;
	}
	public String toString(){
		return "nofix application: first app : "
		+ s1 + " and expr: " + e + " with second app: " + s2;
	}
}
