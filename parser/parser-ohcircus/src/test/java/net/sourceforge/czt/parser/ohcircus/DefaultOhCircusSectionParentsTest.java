 ...
 *
 */
public class DefaultOhCircusSectionParentsTest {

	DefaultOhCircusSectionParentsCommand cmd_;
	@Before
	public void setUp() throws Exception {
		cmd_ = new DefaultOhCircusSectionParentsCommand();
	}
	...
	public void testAnonymous() {
		assertEquals(cmd_.defaultParents(Section.ANONYMOUS.getName()), 
				ZUtils.parentsArgListAsSetOfString(
									...
									Section.OHCIRCUS_TOOLKIT.getName()));
	}
	...
	public void testMySect() {
		...
		try
		{
			...
			SectionManager sm_ = new SectionManager(Dialect.OHCIRCUS);
