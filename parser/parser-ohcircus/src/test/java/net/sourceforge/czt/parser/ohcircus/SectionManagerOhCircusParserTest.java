 ...
 * @author leo
 */
public class SectionManagerOhCircusParserTest extends TestCase
{
 ...
 // true => looks into tests/ohcircus/debug/*.tex;
  ...
  public SectionManagerOhCircusParserTest(String testName)
  {
    super(testName);
  }
  ...
  protected void setUp() throws Exception
  {
    ...
    manager_ = new SectionManager(Dialect.OHCIRCUS);
