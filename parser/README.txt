...
Make sure that ant is in your search path, JFlex.jar has been
copied to <ANT_HOME>/lib/ directory as described in
<JFLEX_HOME>/doc/jflex_anttask.html, and the properties
in <CZT_HOME>/czt.properties are set appropriatly.
