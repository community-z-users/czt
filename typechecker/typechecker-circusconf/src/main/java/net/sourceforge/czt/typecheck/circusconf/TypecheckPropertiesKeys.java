...
public interface TypecheckPropertiesKeys
  extends net.sourceforge.czt.typecheck.circus.TypecheckPropertiesKeys
{
 
  String PROP_TYPECHECK_XXXX =
    "circusconf_typecheck_XXXX";
  
  
  boolean PROP_TYPECHECK_XXXX_DEFAULT      = false;
}
