...
import net.sourceforge.czt.circusconf.impl.CircusConfFactoryImpl;
...
private String stackTraceAsString(Throwable e)
                                                ...
                                                String sectName)
  {
    ...
    CircusConfFactory circusConfFactory = new CircusConfFactoryImpl();
    //((net.sourceforge.czt.z.util.PrintVisitor)((ZFactoryImpl)zFactory).getToStringVisitor()).setPrintIds(true);
    TypeChecker typeChecker = new TypeChecker(
      new net.sourceforge.czt.typecheck.circusconf.impl.Factory(zFactory, circusFactory, circusConfFactory), 
