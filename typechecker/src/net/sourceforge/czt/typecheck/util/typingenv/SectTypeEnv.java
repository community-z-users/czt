...
public class SectTypeEnv {
	...
	public SectTypeEnv () {
		typeEnv = new Vector(10, 5);
	}

	public NameSectTypeTriple addNameSectTypePair(NameSectTypeTriple ntPair) throws TypeException {
	...
	public NameSectTypeTriple search(String name) {
		...
		for (int i = typeEnv.size()-1; i >= 0; i--) {
			temp = (NameSectTypeTriple) typeEnv.get(i);
