  ...
  implements ErrorFactory
{
  ...
  public ErrorAnn parameterMismatch(RefExpr refExpr, int paramLength)
  {
    ...
    return errorAnn(nearestLocAnn(refExpr), message);
  }
  ...
  public ErrorAnn redeclaredSection(ZSect zSect)
  {
    ...
    return errorAnn(nearestLocAnn(zSect), message);
  }
  ...
  public ErrorAnn redeclaredParent(Parent parent, String sectionName)
  {
    ...
    return errorAnn(nearestLocAnn(parent), message);
  }
  ...
  public ErrorAnn strokeInGiven(DeclName declName)
  {
    ...
    return errorAnn(nearestLocAnn(declName), message);
  }
  ...
  public ErrorAnn nonSetInProdExpr(ProdExpr prodExpr, Type type, int exprPos)
  {
    String message =
      ...
      "\tArgument " + position(prodExpr) + " type: " + formatType(type);
    return errorAnn(nearestLocAnn(prodExpr), message);
  }
  ...
  public ErrorAnn nonSchExprInInclDecl(InclDecl inclDecl, Type type)
  {
    ...
    return errorAnn(nearestLocAnn(inclDecl), message);
  }
                                            ...
                                            Type type)
  {
    ...
    return errorAnn(nearestLocAnn(tupleSelExpr), message);
  }
  ...
  public ErrorAnn nonSchExprInThetaExpr(ThetaExpr thetaExpr, Type type)
  {
    String message =
      ...
      "\tArgument type: " + formatType(type);
    return errorAnn(nearestLocAnn(thetaExpr), message);
  }
  ...
  public ErrorAnn nonSchExprInHideExpr(HideExpr hideExpr, Type type)
  {
    String message =
      ...
      "\tType: " + formatType(type);
    return errorAnn(nearestLocAnn(hideExpr), message);
  }
  ...
  public ErrorAnn nonSchExprInPreExpr(PreExpr preExpr, Type type)
  {
    String message =
      ...
      "\tType: " + formatType(type);
    return errorAnn(nearestLocAnn(preExpr), message);
  }
  ...
  public ErrorAnn nonSchExprInExprPred(ExprPred exprPred, Type type)
  {
    String message =
      ...
      "\tType: " + formatType(type);
    return errorAnn(nearestLocAnn(exprPred), message);
  }
  ...
  public ErrorAnn nonSchExprInSchExpr2(SchExpr2 schExpr2, Type type)
  {
    ...
    String message =
      ...
      "\tType: " + formatType(type);
    return errorAnn(nearestLocAnn(schExpr2), message);
  }
  ...
  public ErrorAnn nonFunctionInApplExpr(ApplExpr applExpr, Type type)
  {
    String message =
      ...
      "\tFound type: " + formatType(type);
    return errorAnn(nearestLocAnn(applExpr), message);
  }
                                        ...
                                        Type expectedType)
  {
    ...
    return errorAnn(nearestLocAnn(setExpr), message);
  }
                                         ...
                                         Type rightType)
  {
    ...
    return errorAnn(nearestLocAnn(condExpr), message);
  }
                                        ...
                                        Type rightType)
  {
    ...
    return errorAnn(nearestLocAnn(memPred), message);
  }
                                              ...
                                              Type secondUnification)
  {
    ...
    return errorAnn(nearestLocAnn(andPred), message);
  }
  ...
  public ErrorAnn duplicateInBindExpr(BindExpr bindExpr, DeclName declName)
  {
    ...
    return errorAnn(nearestLocAnn(bindExpr), message);
  }
  ...
  protected ErrorAnn errorAnn(LocAnn position, String message)
  {
