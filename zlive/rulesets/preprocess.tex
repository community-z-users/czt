...
% NOTE: we want to define a relset function, with this type,
% but cannot, because the result of unfolding must be valid
% in the user's ZSect.
%\begin{gendef}[T1,T2]
%  relset : (\power T1) \cross (\power T2) \cross \{0,1\} 
%             \cross \{0,1\} \cross \{0,1\} \cross \{0,1\}
%           \fun \power \power (T1 \cross T2)
%\end{gendef}
