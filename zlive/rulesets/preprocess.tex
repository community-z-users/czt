...
TODO: I need to add a rule for unfolding $\theta$ expressions, which
are tricky because of their strange decoration semantics.
...
\begin{zedrule}{mudecls}
   [D | true] \declListUnfoldsTo [D2 | P2]
\derives
   (\mu D | P @ E) = (\mu D2 | P \land P2 @ E)
\end{zedrule}
