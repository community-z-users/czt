...
%% Syntax within provisos (TODO: move these into zpattern_toolkit).
...
\begin{zedjoker}{Expr} E, E1, E2, E3, E4 \end{zedjoker}
\begin{zedjoker}{Name} v, v1, v2, v3, v4 \end{zedjoker}

\newcommand{\unfoldsTo}{\mathrel{\leadsto}}

We define some operators for manipulating schema signatures.
