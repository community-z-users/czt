...
package net.sourceforge.czt.z2prob;
 ...
 * @author nljsf
 */
public class CZT2ProBPrintingTest extends CztManagedTest {

  protected CZT2ProBPrintingTest(boolean debug)
  {
    super(Dialect.Z, debug);
  }

  protected CZT2ProBPrintingTest(SectionManager manager, boolean debug)
  {
    super(manager, debug);
    if (manager.getDialect().equals("z"))
  ...
  protected void testing(URL resource, Spec term) throws Exception
  {
    ...
    if (DEBUG_TESTING) { System.out.println(result.size() + " ProB command(s) created:\n"); }
  ...
  public static Test suite()
  {
    ...
    if (DEBUG_TESTING)
    {
      System.out.println("Number of tests for Z to ProB XML protocol printing: " + result.countTestCases());
      System.out.println();
    }
    return result;
  }
