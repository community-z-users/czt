...
\usepackage[colour]{czt} % this document describes czt.sty
%usepackage[lucida,colour]{czt} % to test lucida bright
...
% Fuzz toolkit file
\newcommand{\fuzztkfile}{\emfile{fuzz\_toolkit.tex}}

\newcommand{\smallcaption}[1]{{\small (#1)}}

% Fuzz synonyms for Z letters and prefix operators
\newcommand{\integer}{\num}
\newcommand{\natone}{\nat_1}
\newcommand{\fset}{\finset}
\newcommand{\fsetone}{\fset_1}
\newcommand{\pset}{\power_1}
\newcommand{\psetone}{\power}
...
%
% \land is already given in AMS font
...
%\let\xprec\prec  - for Circus
%\def\simulates {\zbinop{\xprec}}
